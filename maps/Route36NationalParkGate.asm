	object_const_def
	const ROUTE_36NATIONALPARKGATE_OFFICER1
	const ROUTE_36NATIONALPARKGATE_BUG_CATCHER1
	const ROUTE_36NATIONALPARKGATE_BUG_CATCHER2
	const ROUTE_36NATIONALPARKGATE_COOLTRAINER_M
	const ROUTE_36NATIONALPARKGATE_POKEFAN_M
	const ROUTE_36NATIONALPARKGATE_BUG_CATCHER3
	const ROUTE_36NATIONALPARKGATE_YOUNGSTER1
	const ROUTE_36NATIONALPARKGATE_LASS
	const ROUTE_36NATIONALPARKGATE_BUG_CATCHER4
	const ROUTE_36NATIONALPARKGATE_YOUNGSTER2
	const ROUTE_36NATIONALPARKGATE_YOUNGSTER3
	const ROUTE_36NATIONALPARKGATE_OFFICER2

Route36NationalParkGate_MapScripts:
	def_scene_scripts
	scene_script Route36NationalParkGateNoop1Scene,             SCENE_ROUTE_36NATIONALPARKGATE_NOOP
	scene_script Route36NationalParkGateNoop2Scene,             SCENE_ROUTE_36NATIONALPARKGATE_UNUSED
	scene_script Route36NationalParkGateLeaveContestEarlyScene, SCENE_ROUTE_36NATIONALPARKGATE_LEAVE_CONTEST_EARLY
...
Route36NationalParkGateCheckIfContestRunningCallback:
	...
	setscene SCENE_ROUTE_36NATIONALPARKGATE_NOOP
	endcallback

.BugContestIsRunning:
	setscene SCENE_ROUTE_36NATIONALPARKGATE_LEAVE_CONTEST_EARLY
	endcallback
...
.SetContestOfficer:
	appear ROUTE_36NATIONALPARKGATE_OFFICER1
	disappear ROUTE_36NATIONALPARKGATE_OFFICER2
.Return:
	endcallback
...
.CopyContestants:
	...
	iftrue .Not1
	appear ROUTE_36NATIONALPARKGATE_BUG_CATCHER1
.Not1:
	checkevent EVENT_BUG_CATCHING_CONTESTANT_2A
	iftrue .Not2
	appear ROUTE_36NATIONALPARKGATE_BUG_CATCHER2
.Not2:
	checkevent EVENT_BUG_CATCHING_CONTESTANT_3A
	iftrue .Not3
	appear ROUTE_36NATIONALPARKGATE_COOLTRAINER_M
.Not3:
	checkevent EVENT_BUG_CATCHING_CONTESTANT_4A
	iftrue .Not4
	appear ROUTE_36NATIONALPARKGATE_POKEFAN_M
.Not4:
	checkevent EVENT_BUG_CATCHING_CONTESTANT_5A
	iftrue .Not5
	appear ROUTE_36NATIONALPARKGATE_BUG_CATCHER3
.Not5:
	checkevent EVENT_BUG_CATCHING_CONTESTANT_6A
	iftrue .Not6
	appear ROUTE_36NATIONALPARKGATE_YOUNGSTER1
.Not6:
	checkevent EVENT_BUG_CATCHING_CONTESTANT_7A
	iftrue .Not7
	appear ROUTE_36NATIONALPARKGATE_LASS
.Not7:
	checkevent EVENT_BUG_CATCHING_CONTESTANT_8A
	iftrue .Not8
	appear ROUTE_36NATIONALPARKGATE_BUG_CATCHER4
.Not8:
	checkevent EVENT_BUG_CATCHING_CONTESTANT_9A
	iftrue .Not9
	appear ROUTE_36NATIONALPARKGATE_YOUNGSTER2
.Not9:
	checkevent EVENT_BUG_CATCHING_CONTESTANT_10A
	iftrue .Not10
	appear ROUTE_36NATIONALPARKGATE_YOUNGSTER3
.Not10:
...
Route36NationalParkGate_MapEvents:
	...
	object_event  4,  5, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, BugCatchingContestant2BScript, EVENT_BUG_CATCHING_CONTESTANT_2B
	...
	object_event  4,  7, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, BugCatchingContestant8BScript, EVENT_BUG_CATCHING_CONTESTANT_8B
	...
	object_event  6,  6, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BugCatchingContestant10BScript, EVENT_BUG_CATCHING_CONTESTANT_10B
	object_event  4,  1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route36NationalParkGateOfficerScript, EVENT_ROUTE_36_NATIONAL_PARK_GATE_OFFICER_NOT_CONTEST_DAY
