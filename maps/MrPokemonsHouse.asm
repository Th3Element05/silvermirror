...
;	bg_event  7,  4, BGEVENT_UP, MrPokemonsHouse_BrokenComputer
	...
	object_event  3,  4, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, MrPokemonsHouse_MrPokemonScript, EVENT_MET_PROF_ELM
	object_event  6,  5, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, MORN | DAY, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, MrPokemonsHouse_MrPokemonScript, EVENT_MR_POKEMONS_HOUSE_MR_POKEMON
	object_event  3,  1, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, EVE | NITE, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, MrPokemonsHouse_MrPokemonScript, EVENT_MR_POKEMONS_HOUSE_MR_POKEMON
