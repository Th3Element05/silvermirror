...
CeladonCity_MapEvents:
	...
	bg_event  9, 27, BGEVENT_READ, CeladonGymSign
	...
	object_event 20, 16, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonCityTutorGrampsScript, -1
	...
	object_event 22, 22, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeladonCityGramps2Script, -1
