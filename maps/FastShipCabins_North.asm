...
FastShipCabins_North_MapEvents:
	...
	def_object_events
	object_event 13,  4, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 2, TrainerGentlemanRichard, EVENT_FAST_SHIP_TRAINERS_1A
