...
SafariZoneWardensHome_MapEvents:
	...
	def_bg_events
;	bg_event  2,  1, BGEVENT_READ, WardensHomeBookshelf
;	bg_event  5,  1, BGEVENT_READ, WardensHomeBookshelf
;	bg_event  1,  0, BGEVENT_READ, WardenPhoto
;	bg_event  7,  0, BGEVENT_READ, SafariZonePhoto

	def_object_events
;	object_event  1,  4, SPRITE_LASS, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, WardensGranddaughter, -1
