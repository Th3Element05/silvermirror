...
DragonShrine_MapEvents:
	...
	object_event  4,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, DragonsShrineDratiniPokeball, EVENT_DRAGON_SHRINE_DRATINI_POKEBALL
