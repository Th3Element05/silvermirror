...
.ThirdSet
	checkevent EVENT_BEAT_ROCKET_FANATIC
	iffalse .End
	changeblock 16, 2, $09 ; floor
	changeblock 14, 2, $1a ; boxes
.End
	end
...
GoldenrodDeptStoreB1F_MapEvents:
	...
	object_event 15, 14, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, GoldenrodDeptStoreB1FPPUp, EVENT_GOLDENROD_DEPT_STORE_B1F_PP_UP
	object_event  6,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, GoldenrodDeptStoreB1FUltraBall, EVENT_GOLDENROD_DEPT_STORE_B1F_ULTRA_BALL
