...
GoldenrodUnderground_MapEvents:
	...
	warp_event  5,  6, GOLDENROD_UNDERGROUND, 4
	warp_event 13, 19, GOLDENROD_UNDERGROUND, 3
	warp_event 14, 19, GOLDENROD_UNDERGROUND, 3
	warp_event 14, 15, GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES, 1
