...
FastShipCabins_South_MapEvents:
	...
	object_event 25,  5, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, FastShipCabinsSouthGentleman, EVENT_FAST_SHIP_TRAINERS_3A
	object_event 28,  5, SPRITE_GENTLEMAN, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 2, TrainerGentlemanVictor, EVENT_FAST_SHIP_TRAINERS_3B
