...
RocketHideoutB4F_MapEvents:
	...
	object_event  3,  2, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerRocketGruntF3, EVENT_BEAT_GIOVANNI
	...
	object_event  1,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, RocketHideoutB4FTMAirSlice, EVENT_ROCKET_HIDEOUT_B4F_TM_AIR_SLICE
