...
KarenScript_Battle:
	faceplayer
	opentext
	checkevent EVENT_BEAT_E4_KAREN
...
KarensRoom_MapEvents:
	...
	def_object_events
	object_event  5,  7, SPRITE_AGATHA, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, KarenScript_Battle, -1
