...
OlivineLighthouse2F_MapEvents:
	...
	def_warp_events
	warp_event  3, 11, OLIVINE_LIGHTHOUSE_1F, 4
	warp_event  5,  3, OLIVINE_LIGHTHOUSE_3F, 2
	warp_event 16, 13, OLIVINE_LIGHTHOUSE_1F, 5
	warp_event 17, 13, OLIVINE_LIGHTHOUSE_1F, 6
...
;	object_event 17,  8, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 3, TrainerGentlemanAlfred, -1
