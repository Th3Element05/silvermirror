Route23North_MapScripts:
	def_scene_scripts

	def_callbacks
	callback MAPCALLBACK_NEWMAP, Route23NorthFlypointCallback

Route23NorthFlypointCallback:
...
Route23North_MapEvents:
	db 0, 0 ; filler

	def_warp_events
	warp_event  9,  5, INDIGO_PLATEAU_POKECENTER_1F, 1 ;1
	warp_event 10,  5, INDIGO_PLATEAU_POKECENTER_1F, 1 ;2
