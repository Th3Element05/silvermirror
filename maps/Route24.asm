...
CamperTannerAfterBattleText:
	ntag "TANNER:"
	text "I like to search"
	line "for treasure in"
	cont "the grass!"
	done
...
Route24_MapEvents:
	...
	object_event 10, 19, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerCamperIvan, -1 ;EVENT_HELPED_BILL
	...
	object_event 10, 25, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerYoungsterAlbert, -1
	...
	object_event 10, 31, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerBugCatcherWayne, -1
	object_event  5, 20, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 4, TrainerCamperTanner, -1 ;EVENT_GOT_HM01_CUT
