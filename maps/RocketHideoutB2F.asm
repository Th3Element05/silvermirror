...
;	object_event  6,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, RocketHideoutB2FTMHornDrill, EVENT_ROCKET_HIDEOUT_B2F_TM_HORN_DRILL
