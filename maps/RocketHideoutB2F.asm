...
RocketHideoutB2F_MapEvents:
	...
	def_object_events
	object_event 20,  6, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 4, TrainerRocketGruntM11, EVENT_BEAT_GIOVANNI
	...
	object_event  6,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, RocketHideoutB2FTMHoneClaws, EVENT_ROCKET_HIDEOUT_B2F_TM_HONE_CLAWS
