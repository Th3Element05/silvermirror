...
OlivinePokecenter1FHappinessRaterScript:
...
OlivinePokecenter1F_MapEvents:
	...
	object_event  6,  2, SPRITE_NURSE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, OlivinePokecenter1FHappinessRaterScript, -1
	...
	object_event  7,  6, SPRITE_TEACHER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivinePokecenter1FTeacherScript, -1
