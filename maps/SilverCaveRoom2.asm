...
SilverCaveRoom2_MapEvents:
	...
	warp_event 13, 21, SILVER_CAVE_ROOM_3, 2 ;SILVER_CAVE_ITEM_ROOMS, 1
	warp_event 23,  3, SILVER_CAVE_ROOM_3, 3 ;SILVER_CAVE_ITEM_ROOMS, 2
;	warp_event 23,  7, SILVER_CAVE_ITEM_ROOMS, 3
