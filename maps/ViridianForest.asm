...
ViridianForest_MapEvents:
	...
	object_event 19, 21, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, ViridianForestSilverPowder, EVENT_VIRIDIAN_FOREST_SILVER_POWDER
	object_event 20, 19, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, ViridianForestTMSilverWind, EVENT_VIRIDIAN_FOREST_TM_SILVER_WIND
