...
.StoppedCrying:
	checkevent EVENT_GOT_TM73_ATTRACT
	iftrue .GotAttract
...
GoldenrodGym_MapEvents:
	...
	def_object_events
	object_event  8,  3, SPRITE_WHITNEY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodGymWhitneyScript, EVENT_JOHTO_GYM_LEADERS
	...
	object_event  5, 15, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, GoldenrodGymGuideScript, -1
;
