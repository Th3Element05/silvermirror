	object_const_def
	const ROUTE_38ECRUTEAKGATE_OFFICER
...
Route38EcruteakGate_MapEvents:
	...
	warp_event  7,  4, ECRUTEAK_CITY, 14
	warp_event  7,  5, ECRUTEAK_CITY, 15
	...
	def_object_events
	object_event  4,  1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route38EcruteakGateOfficerScript, -1
