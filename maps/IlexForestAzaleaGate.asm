...
IlexForestAzaleaGate_MapEvents:
	...
	warp_event  7,  4, AZALEA_TOWN, 7
	warp_event  7,  5, AZALEA_TOWN, 8
	...
	def_object_events
	object_event  4,  1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, IlexForestAzaleaGateOfficerScript, -1
