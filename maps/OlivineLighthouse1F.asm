...
OlivineLighthouse1F_MapEvents:
	...
	def_warp_events
	warp_event  8, 15, OLIVINE_CITY, 9
	warp_event  9, 15, OLIVINE_CITY, 9
	warp_event  3,  7, OLIVINE_LIGHTHOUSE_2F, 1
	warp_event 16, 11, OLIVINE_LIGHTHOUSE_2F, 3
	warp_event 17, 11, OLIVINE_LIGHTHOUSE_2F, 4
	...
	def_object_events
	object_event  5,  3, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouse1FSailorScript, -1
	object_event 14,  7, SPRITE_POKEFAN_F, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouse1FPokefanFScript, -1
