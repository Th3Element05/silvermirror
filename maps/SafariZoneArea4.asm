...
;
	object_event  9, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_ITEMBALL, 0, SafariZoneArea4TMRoost, EVENT_SAFARI_ZONE_AREA_4_TM_ROOST
