...
SSAnneRooms2F_MapEvents:
	...
	def_object_events
	object_event  0,  4, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 2, TrainerGentlemanGregory, EVENT_SSANNE_FIRST_VISIT_NPCS
	...
	object_event 16,  6, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 3, TrainerGentlemanWesley, EVENT_SSANNE_FIRST_VISIT_NPCS
;rematch trainers
	object_event  0,  7, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 3, TrainerGentlemanAlfred, EVENT_SSANNE_TRAINERS_1C
