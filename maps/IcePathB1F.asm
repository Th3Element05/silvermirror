...
IcePathB1F_MapEvents:
	...
	def_bg_events
	bg_event 18, 31, BGEVENT_ITEM, IcePathB1FHiddenMaxPotion
	...
	object_event  5, 34, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, IcePathB1FIron, EVENT_ICE_PATH_B1F_IRON
