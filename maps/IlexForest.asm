...
IlexForestShrineScript:
	checkevent EVENT_PUT_GS_BALL_IN_SHRINE
	iftrue .AskCelebiEventTakeTwo
...
.AskCelebiEventTakeTwo:
	opentext
	writetext Text_ShrineCelebiEventTakeTwo
	yesorno
	iftrue .CelebiEventTakeTwo
	closetext
	end

.CelebiEvent:
	setevent EVENT_PUT_GS_BALL_IN_SHRINE
	takeitem GS_BALL
...
.CelebiEventTakeTwo:
	...
	clearevent EVENT_PUT_GS_BALL_IN_SHRINE
...
IlexForestHiddenHyperPotion:
	hiddenitem HYPER_POTION, EVENT_ILEX_FOREST_HIDDEN_HYPER_POTION
...
IlexForest_MapEvents:
	...
	def_warp_events
	warp_event  2,  5, ROUTE_34_ILEX_FOREST_GATE, 3
...
;	object_event  5, 28, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IlexForestCharcoalMasterScript, EVENT_ILEX_FOREST_CHARCOAL_MASTER
	...
	object_event 12,  1, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 0, TrainerBugCatcherArnie, -1 ;wayne
...
;
;GotCutPagerText:
;	text "SCYTHER was" ;silvermirror -"SCYTHER CHOP was"
