...
CeruleanCaveB1F_MapEvents:
	...
	object_event 30, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, CeruleanCaveB1FBerserkGene, EVENT_CERULEAN_CAVE_B1F_BERSERK_GENE
