...
MountMortarB1F_MapEvents:
	...
	def_warp_events
	warp_event  3,  3, MOUNT_MORTAR_1F_INSIDE, 5 ;1
	warp_event 19, 29, MOUNT_MORTAR_1F_OUTSIDE, 7 ;2
	...
	def_object_events
	object_event 16,  4, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, MountMortarB1FKiyoScript, -1
