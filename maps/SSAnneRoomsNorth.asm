...
SSAnneRoomsNorth_MapEvents:
	...
	object_event 25,  4, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 3, TrainerGentlemanEdward, EVENT_SSANNE_FIRST_VISIT_NPCS
	object_event 34,  4, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 2, TrainerGentlemanPreston, EVENT_SSANNE_FIRST_VISIT_NPCS
; rematch trainers
	...
	object_event 18,  3, SPRITE_GENTLEMAN, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 2, TrainerGentlemanBlake, EVENT_SSANNE_TRAINERS_3A
...
; npcs
	...
	object_event 17,  5, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SSAnneRoomsNorthGentlemanScript, EVENT_SSANNE_FIRST_VISIT_NPCS
