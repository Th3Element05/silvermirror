...
VictoryRoadGate_MapEvents:
	...
	object_event  8,  5, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VictoryRoadGateBlackBeltScript2, EVENT_VICTORY_ROAD_GATE_BLACKBELT
