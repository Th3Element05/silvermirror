...
;	object_event 19, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_ITEMBALL, 0, SafariZoneArea2TMEggBomb, EVENT_SAFARI_ZONE_AREA_2_TM_EGG_BOMB
	object_event 19, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_ITEMBALL, 0, SafariZoneArea2TMBulletSeed, EVENT_SAFARI_ZONE_AREA_2_TM_BULLET_SEED
