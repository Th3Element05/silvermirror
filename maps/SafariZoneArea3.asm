...
;
	...
	object_event 19,  7, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_ITEMBALL, 0, SafariZoneArea3TMPoisonJab, EVENT_SAFARI_ZONE_AREA_3_TM_POISON_JAB
