...
FuchsiaMovesHouseSign:
	jumptext FuchsiaMovesHouseSignText
FuchsiaMovesHouseSignText:
...
FuchsiaCity_MapEvents:
	...
	warp_event 13, 27, FUCHSIA_MOVES_HOUSE, 1      ; 7 ; BILLS_BROTHERS_HOUSE
	...
	bg_event  9, 27, BGEVENT_READ, FuchsiaGymSign
	...
	bg_event 13, 29, BGEVENT_READ, FuchsiaMovesHouseSign
