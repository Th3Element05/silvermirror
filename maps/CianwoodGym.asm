...
ChuckExplainWhirlpoolText:
	...
	cont "WHIRLPOOL to calm"
	roll "turbulent water."

	para "You should be able"
	line "to get past the"
	cont "whirlpools around"
	roll "the WHIRL ISLANDS."
...
CianwoodGym_MapEvents:
	...
	def_object_events
	object_event  4,  1, SPRITE_CHUCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodGymChuckScript, EVENT_JOHTO_GYM_LEADERS
	...
	object_event  4, 12, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, GymClosedBlackbeltScript, EVENT_ROUTE_42_BOULDERS_CLEARED
	object_event  5, 12, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, GymClosedBlackbeltScript, EVENT_ROUTE_42_BOULDERS_CLEARED
	object_event  3, 11, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 2, TrainerBlackbeltLee, EVENT_CIANWOOD_GYM_TRAINERS ;nob
	object_event  5,  7, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 1, TrainerBlackbeltLao, EVENT_CIANWOOD_GYM_TRAINERS ;lung
...
;	object_event  3,  9, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 2, TrainerBlackbeltYoshi, -1
;	object_event  5,  5, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_TRAINER, 1, TrainerBlackbeltLao, -1
;
	object_event  4,  1, SPRITE_CHUCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodGymChuckRematchScript, EVENT_JOHTO_LEADER_REMATCHES
