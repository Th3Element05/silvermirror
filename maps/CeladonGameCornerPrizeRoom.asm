DEF GAMECORNER_CLEFAIRY_COINS     EQU 2000
DEF GAMECORNER_DRATINI_COINS      EQU 4000
DEF GAMECORNER_CHANSEY_COINS      EQU 6000
DEF GAMECORNER_PORYGON_COINS      EQU 8000
;
DEF GAMECORNER_DUNSPARCE_COINS    EQU 2000
DEF GAMECORNER_MURKROW_COINS      EQU 3000
DEF GAMECORNER_SLUGMA_COINS       EQU 4000
DEF GAMECORNER_LARVITAR_COINS     EQU 6000
;
