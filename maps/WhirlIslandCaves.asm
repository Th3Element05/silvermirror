...
;NW
	...
	warp_event  5, 23, WHIRL_ISLAND_B1F_B2F, 1    ;2  ;NW,2
...
;NE
	...
	warp_event 39,  3, WHIRL_ISLAND_B1F_B2F, 2   ;6  ;NE,2
	warp_event 35, 11, WHIRL_ISLAND_B1F_B2F, 3   ;7  ;NE,3
;SW
	warp_event  5,  7, ROUTE_41, 3           ;8  ;SW,1
	warp_event 17,  3, WHIRL_ISLAND_B1F_B2F, 5   ;9  ;SW,2
	warp_event  3,  3, WHIRL_ISLAND_B1F_B2F, 4   ;10 ;SW,3
	warp_event  3, 15, WHIRL_ISLAND_CAVES, 3 ;11 ;SW,4 to NW,3 (to Cave,2)
	warp_event 17, 15, WHIRL_ISLAND_B1F_B2F, 13   ;12 ;SW,5
;SE
	warp_event 35, 35, ROUTE_41, 4           ;13 ;SE,1
	warp_event 35, 25, WHIRL_ISLAND_B1F_B2F, 6   ;14 ;SE,2
;Cave
	warp_event 19, 27, WHIRL_ISLAND_B1F_B2F, 9   ;15 ;Cave,1
