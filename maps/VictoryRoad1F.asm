...
VictoryRoad1F_MapEvents:
	...
	object_event 16,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, VictoryRoad1FTMDragonClaw, EVENT_VICTORY_ROAD_1F_TM_DRAGON_CLAW
