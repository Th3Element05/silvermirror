...
Route31VioletGate_MapEvents:
	...
	warp_event  7,  4, ROUTE_31, 1
	warp_event  7,  5, ROUTE_31, 2
	...
	def_object_events
	object_event  4,  1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route31VioletGateOfficerScript, -1
