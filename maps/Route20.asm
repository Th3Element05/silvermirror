...
Route20_MapEvents:
	...
	object_event 50, 10, SPRITE_VARIABLE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_YELLOW, OBJECTTYPE_SCRIPT, 0, Route20GeodudeScript, EVENT_GOT_TM58_ROCK_SMASH
