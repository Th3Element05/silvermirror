...
PokemonTower7F_MapEvents:
	...
	object_event 10,  8, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerRocketGruntF4, EVENT_BEAT_GRUNTF_4
	...
	object_event  8,  3, SPRITE_ELDER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, PokemonTower7FMrFujiScript, EVENT_POKEMON_TOWER_7F_MR_FUJI
