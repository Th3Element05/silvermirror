...
UnionCave1F_MapEvents:
	...
	object_event 17, 13, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, UnionCave1FBlockingPokemaniac, EVENT_ROUTE_36_OPEN
	object_event 11,  8, SPRITE_SUPER_NERD, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_TRAINER, 1, TrainerPokemaniacMicah, EVENT_ROUTE_36_BATTLE ;larry
