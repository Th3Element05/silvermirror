...
Route23_MapEvents:
	...
	warp_event  8, 19, VICTORY_ROAD_1F, 1 ;5
	warp_event  9, 71, VICTORY_ROAD_GATE, 5 ;6
	warp_event 10, 71, VICTORY_ROAD_GATE, 6 ;7

	def_coord_events

	def_bg_events
	bg_event 11,  7, BGEVENT_READ, IndigoPlateauSign
	bg_event  7, 21, BGEVENT_READ, VictoryRoadSign
