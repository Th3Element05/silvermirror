...
;	setmapscene ROUTE_42, SCENE_ROUTE_42_SUICUNE
;	checkevent EVENT_FOUGHT_EUSINE
;	iftrue .Done
...
;
;GotFlyPagerText:
;	text "PIDGEOT was" ;silvermirror -"PIDGEOT WING was"
...
CianwoodCity_MapEvents:
	...
	def_warp_events
	warp_event 17, 29, MANIAS_HOUSE, 1
	warp_event  8, 31, CIANWOOD_GYM, 1
	warp_event 23, 31, CIANWOOD_POKECENTER_1F, 1
	warp_event 15, 35, CIANWOOD_PHARMACY, 1
	warp_event  9, 19, CIANWOOD_PHOTO_STUDIO, 1
	warp_event 15, 25, CIANWOOD_LUGIA_SPEECH_HOUSE, 1
	warp_event  5,  5, POKE_SEERS_HOUSE, 1
...
;	coord_event 11, 16, SCENE_CIANWOODCITY_SUICUNE_AND_EUSINE, CianwoodCitySuicuneAndEusine
	...
	def_bg_events
	bg_event 20, 22, BGEVENT_READ, CianwoodCitySign
	bg_event  7, 33, BGEVENT_READ, CianwoodGymSign
	bg_event 24, 31, BGEVENT_READ, CianwoodPokecenterSign
	bg_event 19, 35, BGEVENT_READ, CianwoodPharmacySign
	bg_event  8, 20, BGEVENT_READ, CianwoodPhotoStudioSign
	bg_event  8, 12, BGEVENT_READ, CianwoodPokeSeerSign
;	bg_event  6, 26, BGEVENT_READ, CianwoodCliffEdgeGateSign
	bg_event  4,  7, BGEVENT_ITEM, CianwoodCityHiddenRevive
	bg_event  5, 17, BGEVENT_ITEM, CianwoodCityHiddenMaxEther

	def_object_events
	object_event 21, 25, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CianwoodCityYoungster, -1
	object_event 17, 21, SPRITE_POKEFAN_M, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityPokefanM, -1
	object_event 14, 30, SPRITE_LASS, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityLass, -1
	object_event  8,  4, SPRITE_ROCK, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityRock, -1
	object_event  9,  5, SPRITE_ROCK, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityRock, -1
	object_event  4, 13, SPRITE_ROCK, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityRock, -1
	object_event  5, 17, SPRITE_ROCK, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityRock, -1
	object_event 10, 15, SPRITE_ROCK, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityRock, -1
	object_event  4,  7, SPRITE_ROCK, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityRock, -1
;	object_event 10, 46, SPRITE_POKEFAN_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CianwoodCityChucksWife, -1
	object_event 11,  9, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_CIANWOOD_CITY_EUSINE
	object_event 10,  2, SPRITE_SUICUNE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_SAW_SUICUNE_AT_CIANWOOD_CITY
