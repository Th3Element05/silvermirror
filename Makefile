roms := \
	silvermirror.gbc \
	silvermirror_debug.gbc
patches := silvermirror.patch
...
silvermirror_obj       := $(rom_obj:.o=.o)
silvermirror_debug_obj := $(rom_obj:.o=_debug.o)
silvermirror_vc_obj    := $(rom_obj:.o=_vc.o)
...
.SUFFIXES:
.PHONY: all silvmir silvmir_debug clean tidy compare tools
.SECONDEXPANSION:
.PRECIOUS:
.SECONDARY:

all: silvmir silvmir_debug silvmir_vc
silvmir:       silvermirror.gbc
silvmir_debug: silvermirror_debug.gbc
silvmir_vc:    silvermirror.patch
...
$(silvermirror_obj):       RGBASMFLAGS += -D _CRYSTAL11
$(silvermirror_debug_obj): RGBASMFLAGS += -D _CRYSTAL11 -D _DEBUG
$(silvermirror_vc_obj):    RGBASMFLAGS += -D _CRYSTAL11 -D _CRYSTAL11_VC
...
$(foreach obj, $(silvermirror_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
$(foreach obj, $(silvermirror_debug_obj), $(eval $(call DEP,$(obj),$(obj:_debug.o=.asm))))
$(foreach obj, $(silvermirror_vc_obj), $(eval $(call DEP,$(obj),$(obj:_vc.o=.asm))))
...
silvermirror_opt       = -Cjv -t PM_CRYSTAL -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
silvermirror_debug_opt = -Cjv -t PM_CRYSTAL -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
silvermirror_vc_opt    = -Cjv -t PM_CRYSTAL -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
