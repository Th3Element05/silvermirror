...
;TrainerCooltrainermGavin3:
;	trainer COOLTRAINERM, GAVIN3, EVENT_BEAT_COOLTRAINERM_GAVIN, CooltrainermGavin3SeenText, CooltrainermGavin3BeatenText, 0, .Script
...
.Script:
	...
	iftrue .AskedAlready
	writetext CooltrainermGavinAfterText
	promptbutton
...
.AskForNumber:
	...
	ifequal PHONE_CONTACTS_FULL, .PhoneFull
	ifequal PHONE_CONTACT_REFUSED, .NumberDeclined
	gettrainername STRING_BUFFER_3, COOLTRAINERM, GAVIN3
	scall .RegisteredNumber
	jump .NumberAccepted

.WantsBattle:
	scall .Rematch
	winlosstext CooltrainermGavin3BeatenText, 0
	checkevent EVENT_RESTORED_POWER_TO_KANTO
	iftrue .LoadFight2
	checkevent EVENT_BEAT_ELITE_FOUR
	iftrue .LoadFight1
	loadtrainer COOLTRAINERM, GAVIN3
	startbattle
	reloadmapafterbattle
...
.LoadFight2:
	loadtrainer COOLTRAINERM, GAVIN2
	startbattle
	reloadmapafterbattle
	clearflag ENGINE_GAVIN_READY_FOR_REMATCH
	end
