...
; KANTO swarms
	...
	db 25, BELLSPROUT ;  4% chance
	db 25, BELLSPROUT ;  1% chance
...
; JOHTO swarms
	...
	db 24, SWINUB     ; 10% chance
	db 24, GOLBAT     ; 10% chance
	db 23, DELIBIRD   ;  5% chance
	db 24, DELIBIRD   ;  5% chance
	db 24, ZUBAT      ;  4% chance
	db 22, JYNX       ;  1% chance
