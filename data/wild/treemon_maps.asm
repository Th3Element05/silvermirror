...
;	treemon_map ROUTE_27_WEST,             TREEMON_SET_PLAINS
;	treemon_map ROUTE_27_EAST,             TREEMON_SET_PLAINS
...
;;	treemon_map ROUTE_2,                   TREEMON_SET_WESTERN_KANTO
...
;	treemon_map ROUTE_23,                  TREEMON_SET_WESTERN_KANTO
...
;
	...
	treemon_map ROUTE_3,                   TREEMON_SET_NORTHERN_KANTO
	treemon_map ROUTE_4,                   TREEMON_SET_NORTHERN_KANTO
	treemon_map CERULEAN_CITY,             TREEMON_SET_NORTHERN_KANTO
;	treemon_map ROUTE_24,                  TREEMON_SET_NORTHERN_KANTO
	treemon_map ROUTE_25,                  TREEMON_SET_NORTHERN_KANTO
	treemon_map ROUTE_5,                   TREEMON_SET_CENTRAL_KANTO
	treemon_map ROUTE_6,                   TREEMON_SET_CENTRAL_KANTO
...
;	treemon_map LAVENDER_TOWN,             TREEMON_SET_CENTRAL_KANTO
	...
	treemon_map ROUTE_8,                   TREEMON_SET_CENTRAL_KANTO
	treemon_map CELADON_CITY,              TREEMON_SET_CENTRAL_KANTO
;	treemon_map SAFFRON_CITY,              TREEMON_SET_CENTRAL_KANTO
	treemon_map ROUTE_12,                  TREEMON_SET_CENTRAL_KANTO
	treemon_map ROUTE_13,                  TREEMON_SET_CENTRAL_KANTO
	treemon_map ROUTE_14,                  TREEMON_SET_CENTRAL_KANTO
;	treemon_map ROUTE_15,                  TREEMON_SET_CENTRAL_KANTO
	treemon_map ROUTE_16,                  TREEMON_SET_CENTRAL_KANTO
;	treemon_map ROUTE_17,                  TREEMON_SET_CENTRAL_KANTO
;	treemon_map ROUTE_18,                  TREEMON_SET_CENTRAL_KANTO
	treemon_map FUCHSIA_CITY,              TREEMON_SET_CENTRAL_KANTO
;	treemon_map SAFARI_ZONE_AREA_1,        TREEMON_SET_SOUTHERN_KANTO
;	treemon_map SAFARI_ZONE_AREA_2,        TREEMON_SET_NORTHERN_KANTO
;	treemon_map SAFARI_ZONE_AREA_3,        TREEMON_SET_CENTRAL_KANTO
;	treemon_map SAFARI_ZONE_AREA_4,        TREEMON_SET_SAFARI
;	treemon_map ROUTE_19,                  TREEMON_SET_CENTRAL_KANTO
;	treemon_map ROUTE_20,                  TREEMON_SET_CENTRAL_KANTO
;	treemon_map CINNABAR_ISLAND,           TREEMON_SET_SOUTHERN_KANTO
	treemon_map ROUTE_21,                  TREEMON_SET_SOUTHERN_KANTO
;	treemon_map ROUTE_22,                  TREEMON_SET_NORTHERN_KANTO
	treemon_map ROUTE_23,                  TREEMON_SET_SOUTHERN_KANTO
	treemon_map ROUTE_26,                  TREEMON_SET_SOUTHERN_KANTO
	treemon_map ROUTE_27_EAST,             TREEMON_SET_SOUTHERN_KANTO
	treemon_map ROUTE_27_WEST,             TREEMON_SET_ROUTE
;	treemon_map OLIVINE_CITY,              TREEMON_SET_TOWN
	...
	treemon_map ROUTE_37,                  TREEMON_SET_ROUTE
	treemon_map ROUTE_36,                  TREEMON_SET_ROUTE
;	treemon_map NATIONAL_PARK,             TREEMON_SET_FOREST
	treemon_map ROUTE_35,                  TREEMON_SET_YANMA
...
;	treemon_map RUINS_OF_ALPH_OUTSIDE,     TREEMON_SET_TOWN
...
;	treemon_map BLACKTHORN_CITY,           TREEMON_SET_TOWN
	...
	treemon_map ROUTE_42,                  TREEMON_SET_TOWN
	treemon_map ROUTE_43,                  TREEMON_SET_ROUTE
	treemon_map LAKE_OF_RAGE,              TREEMON_SET_ROUTE
;	treemon_map ROUTE_40,                  TREEMON_SET_ROUTE
;	treemon_map ROUTE_41,                  TREEMON_SET_ROUTE
...
;
	...
	treemon_map BURNED_TOWER_B1F,          TREEMON_SET_FIRE_ROCK
	treemon_map ROUTE_42,                  TREEMON_SET_ROCK
	treemon_map ROUTE_40,                  TREEMON_SET_SEA_ROCK_JOHTO
	treemon_map CIANWOOD_CITY,             TREEMON_SET_SEA_ROCK_JOHTO
	treemon_map DARK_CAVE_VIOLET_ENTRANCE, TREEMON_SET_SEA_ROCK_JOHTO
	treemon_map ICE_PATH_B3F,              TREEMON_SET_SEA_ROCK_KANTO
	db -1

;TREEMON_SET_NORTHERN_KANTO
;TREEMON_SET_CENTRAL_KANTO
;TREEMON_SET_SOUTHERN_KANTO
;TREEMON_SET_SAFARI
;TREEMON_SET_TOWN
;TREEMON_SET_ROUTE
;TREEMON_SET_FOREST
;TREEMON_SET_YANMA
;TREEMON_SET_MT_SILVER
;
;TREEMON_SET_ROCK
;TREEMON_SET_SEA_ROCK_KANTO
;TREEMON_SET_SEA_ROCK_JOHTO
;TREEMON_SET_FIRE_ROCK
;TREEMON_SET_POISON_ROCK
