...
;	end_grass_wildmons
	...
	db 17, SENTRET    ;  5% chance
	db 17, RATTATA    ;  4% chance
	db 17, RATTATA    ;  1% chance
	; nite
	db 16, MAGNEMITE  ; 20% chance
	db 17, RATTATA    ; 20% chance
	db 17, RATTATA    ; 15% chance
	db 17, VOLTORB    ; 10% chance
	db 15, ZUBAT      ; 10% chance
	db 16, MAREEP     ; 10% chance
	...
	; day
	db 25, PIDGEY     ; 20% chance
	db 21, BELLSPROUT ; 20% chance
	db 20, DITTO      ; 15% chance
	db 21, BELLSPROUT ; 10% chance
	db 29, WEEPINBELL ; 10% chance
	db 25, PIDGEY     ; 10% chance
	...
	; nite
	db 25, HOOTHOOT   ; 20% chance
	db 21, BELLSPROUT ; 20% chance
	db 20, DITTO      ; 15% chance
	db 21, VENONAT    ; 10% chance
	...
	db 23, GRIMER     ; 15% chance
	db 22, DODUO      ; 10% chance
	db 23, NATU       ; 10% chance
	db 26, RATTATA    ; 10% chance
	db 20, FEAROW     ;  5% chance
	db 20, SPEAROW    ;  5% chance
	db 25, SLUGMA     ;  4% chance
	db 25, SLUGMA     ;  1% chance
	; nite
	...
	db 10 percent, 10 percent, 10 percent ; encounter rates: morn/day/nite
	; day
	db 24, SLUGMA     ; 20% chance
	db 23, DODUO      ; 20% chance
	db 21, DODUO      ; 15% chance
	db 24, NATU       ; 10% chance
	db 22, PONYTA     ; 10% chance
	db 20, PONYTA     ; 10% chance
	db 25, PONYTA     ;  5% chance
	db 21, DODUO      ;  5% chance
	db 26, DODRIO     ;  4% chance
	db 24, SLUGMA     ;  1% chance
	; nite
	db 24, SLUGMA     ; 20% chance
	db 23, MURKROW    ; 20% chance
	db 21, MURKROW    ; 15% chance
	db 24, NATU       ; 10% chance
	db 22, RATTATA    ; 10% chance
	db 20, RATTATA    ; 10% chance
	db 25, RATTATA    ;  5% chance
	...
	db 14, SENTRET    ; 20% chance
	db 15, RATTATA    ; 15% chance
	db 16, PIDGEOTTO  ; 10% chance
	...
	db 13, BELLSPROUT ; 20% chance
	db 12, SUNKERN    ; 15% chance
	...
	db 28, VULPIX     ; 15% chance
	db 28, GROWLITHE  ; 10% chance
	...
	db 22, SLOWPOKE   ; 10% chance
	db 24, SLOWPOKE   ; 10% chance
	db 24, MARILL     ; 10% chance
	db 22, MARILL     ;  5% chance
	db 20, RATTATA    ;  5% chance
	db 20, RATTATA    ;  4% chance
	db 20, RATTATA    ;  1% chance
	end_grass_wildmons
