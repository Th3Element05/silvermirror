...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite MortySpriteGFX, 12, WALKING_SPRITE, PAL_OW_SILVER ;PAL_OW_BROWN
	...
	overworld_sprite PryceSpriteGFX, 12, WALKING_SPRITE, PAL_OW_SILVER ;PAL_OW_BROWN
	...
	overworld_sprite GentlemanSpriteGFX, 12, WALKING_SPRITE, PAL_OW_SILVER
...
; objects
	...
	overworld_sprite PokedexSpriteGFX, 4, STILL_SPRITE, PAL_OW_SILVER
	...
	overworld_sprite ShineSpriteGFX, 8, STANDING_SPRITE, PAL_OW_SILVER
; 5c
; 5d
; 5e
; 5f
