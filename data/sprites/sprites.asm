...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite BlueSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BLUE ; PAL_OW_RED
...
;	overworld_sprite UnusedGuySpriteGFX, 12, STANDING_SPRITE, PAL_OW_RED
	overworld_sprite ChefSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BROWN
...
;	overworld_sprite OldLinkReceptionistSpriteGFX, 12, STANDING_SPRITE, PAL_OW_RED
	...
	overworld_sprite KrisSpriteGFX, 12, WALKING_SPRITE, PAL_OW_GREEN ; PAL_OW_BLUE
	overworld_sprite KrisBikeSpriteGFX, 12, WALKING_SPRITE, PAL_OW_GREEN ; PAL_OW_BLUE
...
;	overworld_sprite AmphySickSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BROWN
	...
	overworld_sprite ClefairyMoveSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
 	...
 	overworld_sprite KrisRunSpriteGFX, 12, WALKING_SPRITE, PAL_OW_GREEN ; PAL_OW_BLUE
