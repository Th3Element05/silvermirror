...
MapScenes::
	scene_var PALLET_TOWN,                                 wPalletTownSceneID ;silvermirror
	scene_var OAKS_LAB,                                    wOaksLabSceneID ;silvermirror
	...
	scene_var CERULEAN_CITY,                               wCeruleanCitySceneID ;silvermirror
