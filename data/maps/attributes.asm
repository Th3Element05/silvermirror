...
;	connection east, Route27, ROUTE_27, 0
	connection east, Route27West, ROUTE_27_WEST, 0
...
;	connection west, Route27, ROUTE_27, 45
	connection west, Route27East, ROUTE_27_EAST, 43 ;45

	map_attributes Route27East, ROUTE_27_EAST, $43, EAST
	connection east, Route26, ROUTE_26, -43 ;-45

;	map_attributes Route27, ROUTE_27, $35, WEST
;	connection west, NewBarkTown, NEW_BARK_TOWN, 0
;	connection east, Route26, ROUTE_26, -45

	map_attributes Route27West, ROUTE_27_WEST, $35, WEST
	connection west, NewBarkTown, NEW_BARK_TOWN, 0
...
;	connection south, Route2, ROUTE_2, 5 ;4
	connection east, Route3, ROUTE_3, 4 ;-6
...
;	connection south, ViridianCity, VIRIDIAN_CITY, -5 ;-4
	...
	connection north, Route2South, ROUTE_2_SOUTH, 5 ;4
;	connection north, Route2, ROUTE_2, 5 ;4
	connection south, Route1, ROUTE_1, 5
	connection west, Route22, ROUTE_22, 4

	map_attributes Route22, ROUTE_22, $2c, NORTH | SOUTH | EAST
	connection north, Route23, ROUTE_23, 0
	connection south, Route26, ROUTE_26, 1
	...
	connection west, Route16, ROUTE_16, 3 ;5
	connection east, Route7, ROUTE_7, 2 ;4

	map_attributes Route7, ROUTE_7, $0f, WEST | EAST
	connection west, CeladonCity, CELADON_CITY, -2 ;-4
	...
	connection north, Route12, ROUTE_12, 27 ;28
	...
	connection south, Route13, ROUTE_13, -27 ;-28
	connection west, Route11, ROUTE_11, 26 ;27

	map_attributes Route11, ROUTE_11, $0f, WEST | EAST
	connection west, VermilionCity, VERMILION_CITY, -4 ;-5
	connection east, Route12, ROUTE_12, -26 ;-27
...
;	connection north, Route10, ROUTE_10, 0
	...
	connection north, Route6, ROUTE_6, 5 ;4
	connection east, Route11, ROUTE_11, 4 ;5

	map_attributes Route6, ROUTE_6, $0f, NORTH | SOUTH
	connection north, SaffronCity, SAFFRON_CITY, -5 ;-2
	connection south, VermilionCity, VERMILION_CITY, -5 ;-4

	map_attributes SaffronCity, SAFFRON_CITY, $0f, NORTH | SOUTH | WEST | EAST
	connection north, Route5, ROUTE_5, 5
	connection south, Route6, ROUTE_6, 5 ;2
	connection west, Route7, ROUTE_7, 5 ;7
	connection east, Route8, ROUTE_8, 5 ;6
	...
	map_attributes Route3, ROUTE_3, $2c, NORTH | WEST ; EAST
	connection north, Route4, ROUTE_4, 24 ; east, Route4, ROUTE_4, 1
	connection west, PewterCity, PEWTER_CITY, -4 ;6

	map_attributes Route4, ROUTE_4, $2c, SOUTH | EAST ; WEST | EAST
	connection south, Route3, ROUTE_3, -24 ; west, Route3, ROUTE_3, -1
...
;	map_attributes VictoryRoad, VICTORY_ROAD, $1d, 0
	...
	map_attributes VictoryRoad2F, VICTORY_ROAD_2F, $1d, 0
	map_attributes VictoryRoad3F, VICTORY_ROAD_3F, $1d, 0
...
;silvermirror+
	...
	map_attributes SSAnneBow, SS_ANNE_BOW, $0A, 0
	...
	map_attributes UndergroundPathEW, UNDERGROUND_PATH_EW, $00, 0
