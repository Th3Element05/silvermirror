...
; pointers to the first map of each map group
	...
	dw MapGroup_SSAnne             ; 15 ; MapGroup_FastShip           ; 15
...
;	map SafariZoneFuchsiaGateBeta, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map SafariZoneBeta, TILESET_PARK, CAVE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
;removed	map CliffEdgeGate, TILESET_CAVE, CAVE, LANDMARK_CLIFF_EDGE_GATE, MUSIC_ROUTE_36, TRUE, PALETTE_NITE, FISHGROUP_POND
;removed	map CliffCave, TILESET_CAVE, CAVE, LANDMARK_CLIFF_CAVE, MUSIC_TITLE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
...
;	map SeafoamGym, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_GYM, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
;	map Route10Pokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_10, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PowerPlant, TILESET_FACILITY, INDOOR, LANDMARK_POWER_PLANT, MUSIC_CITIES_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Azalea:
	table_width MAP_LENGTH, MapGroup_Azalea ;Route33, AzeleaTown, TILESET_JOHTO_MODERN
...
MapGroup_Goldenrod:
	table_width MAP_LENGTH, MapGroup_Goldenrod ;Route34, GoldenrodCity, TILESET_JOHTO_MODERN
...
;	map PewterPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_CITIES_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_SSAnne: ; MapGroup_FastShip:
...
;	map SafariZoneMainOffice, TILESET_GAME_CORNER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map FuchsiaPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;silvermirror moved (why was this in the celadon group?)
...
;	map Route18Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_17, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;silvermirror+
...
;	map TrainerHouse1F, TILESET_HOUSE, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_CITIES_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map TrainerHouseB1F, TILESET_FACILITY, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_CITIES_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map ViridianPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_CITIES_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map SaffronPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_CITIES_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map SilphCo1F, TILESET_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_CITIES_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map Route5CleanseTagHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_5, MUSIC_CITIES_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;silvermirror moved
...
;removed	map Route47, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_47, MUSIC_TITLE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
;removed	map Route48, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_48, MUSIC_TITLE, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
;moved	map SafariZoneEntrance, TILESET_GATE, GATE, LANDMARK_SAFARI_ZONE_GATE, MUSIC_SAFARI_ZONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;removed	map SafariZoneGate, TILESET_JOHTO, TOWN, LANDMARK_SAFARI_ZONE_GATE, MUSIC_SAFARI_ZONE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
;removed	map SafariZoneGatePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SAFARI_ZONE_GATE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;moved	map SafariZoneArea1, TILESET_PARK, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_POND
;moved	map SafariZoneArea2, TILESET_PARK, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
;moved	map SafariZoneArea4, TILESET_PARK, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
;moved	map SafariRestHouseArea1, TILESET_FACILITY, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;moved	map SafariRestHouseArea2, TILESET_FACILITY, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;moved	map SafariRestHouseArea3, TILESET_FACILITY, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;moved	map SafariRestHouseArea4, TILESET_FACILITY, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
