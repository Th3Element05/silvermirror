...
INCLUDE "maps/Route7UndergroundPathEntrance.asm"      ;silvermirror+
INCLUDE "maps/Route18Gate.asm"
INCLUDE "maps/CeladonChiefHouse.asm"                  ;silvermirror+
INCLUDE "maps/CeladonHotel.asm"                       ;silvermirror+
INCLUDE "maps/RocketHideoutB1F.asm"                   ;silvermirror+
INCLUDE "maps/RocketHideoutB2F.asm"                   ;silvermirror+
INCLUDE "maps/RocketHideoutB3F.asm"                   ;silvermirror+
INCLUDE "maps/RocketHideoutB4F.asm"                   ;silvermirror+
...
INCLUDE "maps/MountMoonB2F.asm"                       ;silvermirror+
INCLUDE "maps/UndergroundPath.asm"
INCLUDE "maps/UndergroundPathEW.asm"                  ;silvermirror+
...
INCLUDE "maps/SSAnne1F.asm"                           ;silvermirror+
INCLUDE "maps/SSAnneRooms1F.asm"                      ;silvermirror+
INCLUDE "maps/SSAnneRoomsB1F.asm"                     ;silvermirror+
INCLUDE "maps/SSAnneKitchen.asm"                      ;silvermirror+
INCLUDE "maps/SSAnne2F.asm"                           ;silvermirror+
INCLUDE "maps/SSAnneRooms2F.asm"                      ;silvermirror+
INCLUDE "maps/SSAnneBow.asm"                          ;silvermirror+
...
INCLUDE "maps/PokemonTower1F.asm"                     ;silvermirror+
INCLUDE "maps/PokemonTower2F.asm"                     ;silvermirror+
INCLUDE "maps/PokemonTower3F.asm"                     ;silvermirror+
INCLUDE "maps/PokemonTower4F.asm"                     ;silvermirror+
INCLUDE "maps/PokemonTower5F.asm"                     ;silvermirror+
INCLUDE "maps/PokemonTower6F.asm"                     ;silvermirror+
INCLUDE "maps/PokemonTower7F.asm"                     ;silvermirror+
...
INCLUDE "maps/Route8UndergroundPathEntrance.asm"      ;silvermirror+
...
INCLUDE "maps/Route26Gate.asm"                        ;silvermirror+
...
INCLUDE "maps/CeruleanTrashedHouse.asm"          ;silvermirror+
;INCLUDE "maps/CeruleanPoliceStation.asm"        ;silvermirror-
...
INCLUDE "maps/Route27West.asm"             ;silvermirror+
INCLUDE "maps/Route27East.asm"             ;silvermirror+
...
INCLUDE "maps/Route12Gate.asm"             ;silvermirror+
...
INCLUDE "maps/PokemonMansion2F.asm"    ;silvermirror+
INCLUDE "maps/PokemonMansion3F.asm"    ;silvermirror+
INCLUDE "maps/CinnabarMart.asm"        ;silvermirror+
...
;INCLUDE "maps/Route10.asm"             ;silvermirror+
...
;INCLUDE "maps/RuinsOfAlphHoOhWordRoom.asm"                ;REMOVED from silvermirror
;INCLUDE "maps/RuinsOfAlphKabutoWordRoom.asm"              ;REMOVED from silvermirror
;INCLUDE "maps/RuinsOfAlphOmanyteWordRoom.asm"             ;REMOVED from silvermirror
;INCLUDE "maps/RuinsOfAlphAerodactylWordRoom.asm"          ;REMOVED from silvermirror
...
SECTION "Map Scripts 30", ROMX         ;silvermirror+
