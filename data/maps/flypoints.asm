Flypoints:
; entries correspond to FLY_* constants (constants\map_data_constants.asm)
; Johto
...
; Kanto (this is the order from pokered)
;	db LANDMARK_PALLET_TOWN,      SPAWN_PALLET ; moved to bottom (default kanto flypoint)
...
;	db LANDMARK_MT_MOON,          SPAWN_ROUTE_3
...
;	db LANDMARK_OLIVINE_CITY,     SPAWN_OLIVINE
;	db LANDMARK_CIANWOOD_CITY,    SPAWN_CIANWOOD
;;	db LANDMARK_SAFARI_ZONE_GATE, SPAWN_SAFARI_GATE ; removed
;	db LANDMARK_MAHOGANY_TOWN,    SPAWN_MAHOGANY
;	db LANDMARK_LAKE_OF_RAGE,     SPAWN_LAKE_OF_RAGE
;	db LANDMARK_BLACKTHORN_CITY,  SPAWN_BLACKTHORN
;	db LANDMARK_SILVER_CAVE,      SPAWN_MT_SILVER