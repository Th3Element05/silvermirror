...
Rival1Group:
	; RIVAL1_1_BULBASAUR (1) oaks lab
	db "?@", TRAINERTYPE_NORMAL
	db  5, BULBASAUR
	db -1 ; end

	; RIVAL1_1_CHARMANDER (2) oaks lab
	db "?@", TRAINERTYPE_NORMAL
	db  5, CHARMANDER
	db -1 ; end

	; RIVAL1_1_SQUIRTLE (3) oaks lab
	db "?@", TRAINERTYPE_NORMAL
	db  5, SQUIRTLE
	db -1 ; end

	; RIVAL1_2_BULBASAUR (4) route 22
	db "?@", TRAINERTYPE_NORMAL
	db  9, PIDGEY
	db  8, BULBASAUR
	db -1 ; end

	; RIVAL1_2_CHARMANDER (5) route 22
	db "?@", TRAINERTYPE_NORMAL
	db  9, PIDGEY
	db  8, CHARMANDER
	db -1 ; end

	; RIVAL1_2_SQUIRTLE (6) route 22
	db "?@", TRAINERTYPE_NORMAL
	db  9, PIDGEY
	db  8, SQUIRTLE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 38, STARMIE,    DOUBLE_TEAM, PSYCHIC_M, WATERFALL, CONFUSE_RAY
	db 40, NIDOQUEEN,  EARTHQUAKE, DOUBLE_KICK, TOXIC, BODY_SLAM
	db 38, STARMIE,    BLIZZARD, PSYCHIC_M, WATERFALL, RECOVER
	db -1 ; end
