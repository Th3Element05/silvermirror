...
; BattleTowerMons group 1
	...
	db ESPEON
	db LEFTOVERS
	db MUD_SLAP, PSYCHIC_M, REFLECT, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db UMBREON
	db SITRUS_BERRY
	db SHADOW_BALL, IRON_TAIL, PROTECT, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db BLISSEY
	db QUICK_CLAW
	db HEADBUTT, SOLARBEAM, ROLLOUT, SOFTBOILED
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 32000
	...
	db HERACROSS
	db SITRUS_BERRY
	db FLAIL, ENDURE, COUNTER, BRICK_BREAK
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db MR__MIME
	db QUICK_CLAW
	db TOXIC, BARRIER, FIRE_PUNCH, HEADBUTT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 2
	...
	db STARMIE
	db SITRUS_BERRY
	db RECOVER, PSYCHIC_M, SURF, CONFUSE_RAY
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GYARADOS
	db LUM_BERRY
	db HYPER_BEAM, DRAGONBREATH, THUNDERBOLT, FIRE_BLAST
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ALAKAZAM
	db BERRY_JUICE
	db PSYCHIC_M, REFLECT, TOXIC, THUNDERPUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db AERODACTYL
	db SITRUS_BERRY
	db REST, HYPER_BEAM, EARTHQUAKE, DRAGONBREATH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db PIKACHU
	db LIGHT_BALL
	db THUNDERBOLT, THUNDER_WAVE, BODY_SLAM, TOXIC
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db WIGGLYTUFF
	db SILK_SCARF
	db PSYCHIC_M, SWAGGER, PROTECT, HEADBUTT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 3
	...
	db MAROWAK
	db THICK_CLUB
	db EARTHQUAKE, HEADBUTT, HYPER_BEAM, BONEMERANG
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db LAPRAS
	db LEFTOVERS
	db RAIN_DANCE, WATER_GUN, ICY_WIND, BODY_SLAM
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ESPEON
	db LUM_BERRY
	db CONFUSION, SWIFT, TOXIC, REFLECT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db FEAROW
	db BRIGHTPOWDER
	db STEEL_WING, PURSUIT, PECK, SWIFT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db PRIMEAPE
	db LUM_BERRY
	db LOW_SWEEP, KARATE_CHOP, FLAIL, FOCUS_ENERGY
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 4
	...
	db TAUROS
	db SITRUS_BERRY
	db THRASH, HYPER_BEAM, EARTHQUAKE, IRON_TAIL
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GOLEM
	db FOCUS_BAND
	db SELFDESTRUCT, EARTHQUAKE, DYNAMICPUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db PORYGON;2
	db NO_ITEM
	db CONVERSION, PSYBEAM, THIEF, TRI_ATTACK ;SIGNAL_BEAM
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db OMASTAR
	db SITRUS_BERRY
	db CURSE, WATER_GUN, ANCIENTPOWER, BRICK_BREAK
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHARIZARD
	db KINGS_ROCK
	db FIRE_SPIN, DRAGONBREATH, SKY_ATTACK, SLASH
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db SEED_BOMB, STOMP, GIGA_DRAIN, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 5
	...
	db SKARMORY
	db SITRUS_BERRY
	db SANDSTORM, SKY_ATTACK, STEEL_WING, TOXIC
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
...
; BattleTowerMons group 6
	...
	db SKARMORY
	db LUM_BERRY
	db STEEL_WING, SKY_ATTACK, TOXIC, PROTECT
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GOLEM
	db BRIGHTPOWDER
	db SELFDESTRUCT, EARTHQUAKE, FIRE_PUNCH, DOUBLE_EDGE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 7
	...
	db UMBREON
	db SITRUS_BERRY
	db FEINT_ATTACK, MOONLIGHT, PROTECT, TOXIC
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 54000
	...
	db HITMONLEE
	db FOCUS_BAND
	db FLAIL, ENDURE, BODY_SLAM, JUMP_KICK
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 8
	...
	db SKARMORY
	db QUICK_CLAW
	db STEEL_WING, SKY_ATTACK, MUD_SLAP, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PINSIR
	db SITRUS_BERRY
	db HYPER_BEAM, SUBMISSION, X_SCISSOR, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db ESPEON
	db SITRUS_BERRY
	db PSYCHIC_M, SHADOW_BALL, SUNNY_DAY, SYNTHESIS ;MORNING_SUN
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, BRICK_BREAK, FIRE_BLAST, EARTHQUAKE ;VITAL_THROW=BRICK_BREAK
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SKARMORY
	db QUICK_CLAW
	db SANDSTORM, STEEL_WING, TOXIC, SLASH
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 10
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, EARTHQUAKE, HYPER_BEAM, BRICK_BREAK ;VITAL_THROW=BRICK_BREAK
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db CHARIZARD
	db SCOPE_LENS
	db FLAMETHROWER, EARTHQUAKE, SLASH, SKY_ATTACK
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
