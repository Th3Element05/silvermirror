...
_UseCutText::
	text "Called SCYTHER" ;silvermirror -"<PLAYER> summoned a"
	line "to use CUT!" ;silvermirror -"SCYTHER to use"
;	cont "CUT!" ;silvermirror -
	done
...
_AskRockSmashText::
	...
	para "Do you want to use" ;silvermirror -"Want to use"
	line "ROCK SMASH?" ;silvermirror -"CUBONE SMASH?"
	done
...
_AskCutText::
	...
	para "Do you want to use" ;silvermirror -"Want to use"
	line "CUT?" ;silvermirror -"SCYTHER CHOP?"
	done
...
;_UsedMove1Text::              ;silvermirror simplify grammar table
_UsedMoveText::
	text_start
	line "used @"
	text_end

;_UsedMove2Text::              ;silvermirror simplify grammar table
;	text_start
;	line "used @"
;	text_end
...
_MoveNameText::
	text_ram wStringBuffer2
;	text_end                   ;silvermirror simplify grammar table
