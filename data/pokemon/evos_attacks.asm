...
VenusaurEvosAttacks:
	...
	db 28, GROWTH
	db 31, DOUBLE_EDGE
	db 31, PETAL_DANCE ;32, EVOLUTION_MOVE
...
BeedrillEvosAttacks:
	db 0 ; no more evolutions
;	db 1, PIN_MISSILE
	db 1, PIN_MISSILE ;10, EVOLUTION_MOVE
...
ArbokEvosAttacks:
	...
	db 17, SCREECH
	db 20, ACID
	db 21, CRUNCH ;22, EVOLUTION_MOVE
...
RaichuEvosAttacks:
	...
	db 1, LEER ;tail_whip, removed
	db 1, QUICK_ATTACK
	db 1, THUNDERBOLT ;1, EVOLUTION_MOVE
	db 0 ; no more level-up moves
...
SandslashEvosAttacks:
	...
	db 21, ROLLOUT
	db 21, CRUSH_CLAW ;22, EVOLUTION_MOVE
	db 28, FURY_CUTTER
...
NidoqueenEvosAttacks:
	...
	db 1, DOUBLE_KICK
	db 1, POISON_STING
	db 1, BODY_SLAM ;23, EVOLUTION_MOVE
	db 43, EARTH_POWER
...
NinetalesEvosAttacks:
	db 0 ; no more evolutions
	db 1, NASTY_PLOT ;1, EVOLUTION_MOVE
	db 1, FLAMETHROWER
	db 1, QUICK_ATTACK
	db 1, CONFUSE_RAY
	db 1, SAFEGUARD
...
GolbatEvosAttacks:
	...
	db 17, WING_ATTACK
	db 21, CONFUSE_RAY
	db 21, SCREECH ;22, EVOLUTION_MOVE
...
VileplumeEvosAttacks:
	db 0 ; no more evolutions
	db 1, MEGA_DRAIN
	db 1, HEAL_BELL ;aromatherapy, ~ ;1, EVOLUTION_MOVE
	db 1, STUN_SPORE
	db 1, POISONPOWDER
	db 53, PETAL_DANCE
	db 60, SOLARBEAM
...
DugtrioEvosAttacks:
	db 0 ; no more evolutions
	db 1, NIGHT_SLASH
	db 1, TRI_ATTACK ;1, EVOLUTION_MOVE
	db 1, SCRATCH
	db 1, MUD_SLAP ;sand_attack, removed
	db 4, GROWL
	db 7, ASTONISH
...
ArcanineEvosAttacks:
	...
	db 1, THUNDER_FANG
	db 1, FIRE_FANG
	db 1, EXTREMESPEED ;39, EVOLUTION_MOVE
	db 0 ; no more level-up moves
...
PoliwrathEvosAttacks:
	...
	db 1, HYPNOSIS
	db 1, DOUBLESLAP
	db 1, SUBMISSION ;1, EVOLUTION_MOVE
	db 43, DYNAMICPUNCH
...
MachampEvosAttacks:
	db 0 ; no more evolutions
	db 1, CLOSE_COMBAT ;1, EVOLUTION_MOVE
	db 1, KARATE_CHOP ;low_kick, removed
	db 1, LEER
	db 7, FOCUS_ENERGY
	db 10, LOW_SWEEP ;KARATE_CHOP, 1
...
VictreebelEvosAttacks:
	db 0 ; no more evolutions
	db 1, MAGICAL_LEAF ;1, EVOLUTION_MOVE
	db 1, SYNTHESIS
	db 1, SEED_BOMB
	db 1, VINE_WHIP
	db 1, SLEEP_POWDER
...
RapidashEvosAttacks:
	...
	db 33, AGILITY
	db 37, FIRE_BLAST
	db 39, FURY_STRIKES ;40, EVOLUTION_MOVE
	db 49, BOUNCE
	db 58, FLARE_BLITZ
	db 0 ; no more level-up moves
...
;	db 1, ;YAWN
	...
	db 29, WATER_PULSE
	db 34, ZEN_HEADBUTT
	db 36, DEFENSE_CURL ;37, EVOLUTION_MOVE ;withdraw, removed
...
;	db EVOLVE_ITEM, THUNDERSTONE, MAGNEZONE
	db EVOLVE_LOCATION, LANDMARK_POWER_PLANT, MAGNEZONE
...
DodrioEvosAttacks:
	...
	db 23, LOUD_VOICE ;uproar, ~
	db 28, DOUBLE_TEAM ;accupressure, x
	db 30, TRI_ATTACK ;31, EVOLUTION_MOVE
	db 35, AGILITY
...
DewgongEvosAttacks:
	...
	db 31, AQUA_JET
	db 33, WATER_PULSE ;brine, x
	db 33, HORN_DRILL ;34, EVOLUTION_MOVE ;sheer_cold, ~
	db 37, TAKE_DOWN
	db 41, WATERFALL ;dive, x
	db 43, AQUA_TAIL
	db 47, ICE_BEAM
...
RhydonEvosAttacks:
	...
	db 33, TAKE_DOWN
	db 37, HORN_DRILL
	db 41, CLOSE_COMBAT ;42, EVOLUTION_MOVE ;hammer_arm, x
	db 45, STONE_EDGE
	db 49, EARTHQUAKE
	db 57, MEGAHORN
	db 0 ; no more level-up moves
...
StarmieEvosAttacks:
	...
	db 1, RAPID_SPIN
	db 1, SWIFT
	db 1, CONFUSE_RAY ;28, EVOLUTION_MOVE
	db 0 ; no more level-up moves
...
EeveeEvosAttacks: ; GEN6/7
	...
	db EVOLVE_LOCATION, LANDMARK_VIRIDIAN_FOREST, LEAFEON
	db EVOLVE_LOCATION, LANDMARK_SEAFOAM_ISLANDS, GLACEON
...
VaporeonEvosAttacks: ; GEN6/7
	db 0 ; no more evolutions
	db 1, WATER_GUN ;1, EVOLUTION_MOVE
	db 1, TACKLE
	db 1, GROWL ;baby-doll eyes, x
	db 5, LEER ;tail_whip, x
	db 9, MUD_SLAP ;sand_attack, x
...
JolteonEvosAttacks: ; GEN6/7
	db 0 ; no more evolutions
	db 1, THUNDERSHOCK ;1, EVOLUTION_MOVE
	db 1, TACKLE
	db 1, GROWL ;baby-doll eyes, x
	db 5, LEER ;tail_whip, x
	db 9, MUD_SLAP ;sand_attack, x
...
LeafeonEvosAttacks: ; GEN6/7
	db 0 ; no more evolutions
	db 1, RAZOR_LEAF ;1, EVOLUTION_MOVE
	db 1, TACKLE
	db 1, GROWL ;baby-doll eyes, x
	db 5, LEER ;tail_whip, x
	db 9, MUD_SLAP ;sand_attack, x
...
GlaceonEvosAttacks: ; GEN6/7
	db 0 ; no more evolutions
	db 1, ICY_WIND ;1, EVOLUTION_MOVE
	db 1, TACKLE
	db 1, GROWL ;baby-doll eyes, x
	db 5, LEER ;tail_whip, x
	db 9, MUD_SLAP ;sand_attack, x
...
OmastarEvosAttacks:
	...
	db 34, PROTECT
	db 37, ANCIENTPOWER
	db 39, ICICLE_SPEAR ;40, EVOLUTION_MOVE ;SPIKE_CANNON, removed
...
DragoniteEvosAttacks:
	...
	db 44, SAFEGUARD
	db 49, DRAGON_DANCE
	db 54, WING_ATTACK ;55, EVOLUTION_MOVE
	db 60, OUTRAGE
	db 66, HYPER_BEAM
	db 0 ; no more level-up moves
...
FeraligatrEvosAttacks:
	...
	db 21, ICE_FANG
	db 24, THRASH
	db 29, AGILITY ;30, EVOLUTION_MOVE
	db 32, CRUNCH
	db 37, SLASH
	db 45, SCREECH
	db 50, AQUA_TAIL
...
AriadosEvosAttacks:
	db 0 ; no more evolutions
	db 1, SWORDS_DANCE ;1, EVOLUTION_MOVE
	db 1, POISON_STING
	db 1, STRING_SHOT
	db 5, SCARY_FACE
	db 8, WRAP ;constrict, removed
...
AmpharosEvosAttacks:
	...
	db 20, SPARK ;cotton_spore, removed
	db 25, CONFUSE_RAY ;charge, x
	db 29, THUNDERPUNCH ;30, EVOLUTION_MOVE
	db 34, DISCHARGE
	db 42, SIGNAL_BEAM
	db 51, LIGHT_SCREEN
	db 59, POWER_GEM
...
BellossomEvosAttacks:
	...
	db 1, STUN_SPORE
	db 1, SUNNY_DAY
	db 1, MAGICAL_LEAF ;23, EVOLUTION_MOVE
	db 53, SOLARBEAM ;leaf_storm, x
	db 0 ; no more level-up moves
...
PolitoedEvosAttacks:
	...
	db 1, HYPNOSIS
	db 1, DOUBLESLAP
	db 1, PERISH_SONG ;1, EVOLUTION_MOVE
	db 27, SWAGGER
	db 37, BOUNCE
...
SunfloraEvosAttacks:
	db 0 ; no more evolutions
	db 1, BULLET_SEED ;21, EVOLUTION_MOVE
	db 1, TACKLE ;pound, removed
	db 1, ABSORB
	db 5, GROWTH ;MEGA_DRAIN, 9
	db 9, LEECH_SEED
...
EspeonEvosAttacks: ; GEN6/7
	db 0 ; no more evolutions
	db 1, CONFUSION ;1, EVOLUTION_MOVE
	db 1, TACKLE
	db 1, GROWL ;baby-doll eyes, x
	db 5, LEER ;tail_whip, x
	db 9, MUD_SLAP ;sand_attack, x
...
SlowkingEvosAttacks:
	db 0 ; no more evolutions
	db 1, POWER_GEM
	db 1, HIDDEN_POWER ;1, EVOLUTION_MOVE
	db 1, CURSE
;	db 1, REST ;yawn, x
;	db 1, SNORE ;yawn, x
	db 1, TACKLE
...
ScizorEvosAttacks:
	...
	db 13, FALSE_SWIPE
	db 17, AGILITY
	db 21, METAL_CLAW ;21, EVOLUTION_MOVE
	db 25, FURY_CUTTER
	db 29, SLASH
...
UrsaringEvosAttacks:
	...
	db 22, SWEET_SCENT
	db 29, SLASH
	db 29, SCARY_FACE ;38, EVOLUTION_MOVE
	db 46, REST
	db 46, SNORE
	db 52, THRASH
	db 60, CLOSE_COMBAT ;hammer_arm, x
	db 0 ; no more level-up moves
...
PiloswineEvosAttacks:
	...
	db 28, ICE_FANG
	db 32, TAKE_DOWN
	db 32, FURY_STRIKES ;33, EVOLUTION_MOVE ;fury_attack, removed
	db 40, EARTHQUAKE
	db 48, HAZE ;MIST, removed
	db 56, BLIZZARD
	db 65, AMNESIA
...
MamoswineEvosAttacks:
	...
	db 28, ICE_FANG
	db 32, TAKE_DOWN
	db 32, FURY_STRIKES ;33, EVOLUTION_MOVE (piloswine) ;fury_attack, removed
	db 40, EARTHQUAKE
	db 48, HAZE ;MIST, removed
	db 56, BLIZZARD
	db 65, SCARY_FACE
...
;	db 1, ;gunk_shot, x
	...
	db 19, BUBBLEBEAM
	db 23, FOCUS_ENERGY
	db 24, OCTAZOOKA ;25, EVOLUTION_MOVE
	db 29, BULLET_SEED
