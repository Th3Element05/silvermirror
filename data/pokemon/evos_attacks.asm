...
SandshrewEvosAttacks: ;GEN4
	...
	db 13, RAPID_SPIN
	db 15, SWIFT
	db 19, FURY_STRIKES ;FURY_SWIPES
	db 21, ROLLOUT
	db 25, SLASH
;	db 27, ;SAND_TOMB
	db 31, FURY_CUTTER
...
NidoranMEvosAttacks: ;GEN4
	...
	db 9, DOUBLE_KICK
	db 13, POISON_STING
	db 19, FURY_STRIKES ;FURY_ATTACK
	db 21, HORN_ATTACK
;	db 25, ;HELPING_HAND
;	db 31, ;TOXIC_SPIKES
;	db 33, ;FLATTER
...
NidorinoEvosAttacks: ;GEN4
	...
	db 9, DOUBLE_KICK
	db 13, POISON_STING
	db 20, FURY_STRIKES ;FURY_ATTACK
	db 23, HORN_ATTACK
;	db 28, ;HELPING_HAND
;	db 35, ;TOXIC_SPIKES
;	db 38, ;FLATTER
...
MankeyEvosAttacks: ;GEN4
	...
	db 1, LEER
	db 1, FOCUS_ENERGY
	db 9, LOW_KICK ;KARATE_CHOP
	db 13, FURY_STRIKES ;FURY_SWIPES
	db 17, SEISMIC_TOSS
	db 21, SCREECH
	db 25, KARATE_CHOP ;ASSURANCE
	db 33, SWAGGER
	db 37, CROSS_CHOP
	db 41, THRASH
;	db 45, ;PUNISHMENT
...
;	db 1, POISON_JAB
	...
	db 1, LEER
	db 1, FURY_CUTTER
	db 7, FURY_STRIKES ;FURY_ATTACK
	db 9, THEIF ;KNOCK_OFF
;	db 13, AERIAL_ACE
	db 19, SLASH
;	db 21, AIR_CUTTER
	db 25, SWORDS_DANCE
...
DoduoEvosAttacks: ;GEN4
	...
	db 5, QUICK_ATTACK
	db 10, RAGE
	db 14, FURY_STRIKES ;FURY_ATTACK
	db 19, PURSUIT
;	db 23, ;UPROAR
;	db 28, ;ACCUPRESSURE
...
;	db 1, ;TOXIC_SPIKES
	...
	db 1, PROTECT
	db 28, SPIKES
	db 40, ICICLE_SPEAR ;SPIKE_CANNON
	db 0 ; no more level-up moves
...
RhyhornEvosAttacks: ;GEN4
	...
	db 1, LEER ;TAIL_WHIP
	db 9, STOMP
;	db 13, FURY_STRIKES ;FURY_ATTACK
	db 21, SCARY_FACE
;	db 25, ROCK_BLAST
	db 33, TAKE_DOWN
	db 37, HORN_DRILL
...
;	db 17, ;WATER_PULSE
	db 21, FLAIL
;	db 27, ;AQUA_RING
;	db 31, FURY_STRIKES ;FURY_ATTACK
	db 37, WATERFALL
	db 41, HORN_DRILL
	db 47, AGILITY
	db 51, MEGAHORN
...
SpinarakEvosAttacks: ;GEN4
	...
	db 15, NIGHT_SHADE
;	db 19, SHADOW_SNEAK
	db 22, FURY_STRIKES ;FURY_SWIPES
;	db 26, ;SUCKER_PUNCH
	db 29, SPIDER_WEB
	db 33, AGILITY
	db 36, PIN_MISSILE
...
;	db 1, BUG_BITE
	...
	db 15, NIGHT_SHADE
;	db 19, SHADOW_SNEAK
	db 23, FURY_STRIKES ;FURY_SWIPES
;	db 28, ;SUCKER_PUNCH
	db 32, SPIDER_WEB
	db 37, AGILITY
	db 41, PIN_MISSILE
...
;	db EVOLVE_HOLD, RAZOR_FANG, TR_NITE, GLISCOR
	...
	db 1, POISON_STING
	db 5, SAND_ATTACK
	db 9, DEFENSE_CURL ;HARDEN
	db 12, THEIF ;KNOCK_OFF
	db 16, QUICK_ATTACK
	db 20, FURY_CUTTER
	db 23, FEINT_ATTACK
	db 27, SCREECH
...
;	db 1, ;TAUNT
	...
	db 10, SCREECH
	db 14, FEINT_ATTACK
	db 21, FURY_STRIKES ;FURY_SWIPES
	db 24, AGILITY
	db 28, ICY_WIND
	db 35, SLASH
	db 38, BEAT_UP
...
CorsolaEvosAttacks: ;GEN4
	db 0 ; no more evolutions
	db 1, TACKLE
	db 4, DEFENSE_CURL ;HARDEN
	db 8, WATER_GUN ;BUBBLE
	db 13, RECOVER
;	db 16, ;REFRESH
;	db 20, ROCK_BLAST
	db 25, BUBBLEBEAM
...
SkarmoryEvosAttacks: ;GEN4
	...
	db 9, SWIFT
	db 12, AGILITY
	db 17, FURY_STRIKES ;FURY_ATTACK
;	db 20, FEINT
;	db 23, AIR_CUTTER
	db 28, SPIKES
;	db 31, METAL_SOUND
