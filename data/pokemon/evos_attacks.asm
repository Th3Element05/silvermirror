...
;	db 1, CONFUSION
	...
	db 24, PSYBEAM
	db 28, SIGNAL_BEAM ;silver_wind, x
...
MachopEvosAttacks:
	...
	db 25, ROCK_SMASH ;BRICK_BREAK ;vital_throw, removed
	db 31, SUBMISSION
	db 34, WAKE_UP_SLAP
	db 37, CROSS_CHOP
	db 43, SCARY_FACE
...
VaporeonEvosAttacks:
	...
	db 29, BITE
	db 36, AURORA_BEAM
	db 43, AQUA_JET ;aqua_ring, x
	db 50, MUD_BOMB ;last_resort, x
	db 57, HAZE
...
OmanyteEvosAttacks:
	...
	db 34, PROTECT
	db 37, ANCIENTPOWER
	db 43, RAIN_DANCE ;TICKLE, replace?
	db 46, ROCK_BLAST
	db 52, HYDRO_PUMP
	db 0 ; no more level-up moves
...
OmastarEvosAttacks:
	...
	db 37, ANCIENTPOWER
	db 40, ICICLE_SPEAR ;SPIKE_CANNON, removed ;evolution move?
	db 48, RAIN_DANCE ;TICKLE, replace?
	db 56, ROCK_BLAST
	db 67, HYDRO_PUMP
	db 0 ; no more level-up moves
...
LedybaEvosAttacks:
	...
	db 17, MACH_PUNCH
	db 22, BATON_PASS
	db 25, SIGNAL_BEAM ;silver_wind, x
	db 30, AGILITY
	db 33, SWIFT
	db 38, DOUBLE_EDGE
	db 41, BUG_BUZZ
...
LedianEvosAttacks:
	...
	db 17, MACH_PUNCH
	db 24, BATON_PASS
	db 29, SIGNAL_BEAM ;silver_wind, x
	db 36, AGILITY
	db 41, SWIFT
	db 48, DOUBLE_EDGE
	db 53, BUG_BUZZ
...
MisdreavusEvosAttacks: ;GEN4  ;HEX
