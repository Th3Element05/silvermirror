...
;	db ICON_TOGETIC     ; TOGETIC
	...
	db ICON_GLISCOR     ; GLISCOR ;GLISCOR
	...
	db ICON_WEAVILE     ; WEAVILE ;WEAVILE
	...
	db ICON_MAMOSWINE   ; MAMOSWINE ;MAMOSWINE
...
;	db ICON_TYROGUE     ; TYROGUE ; removed (not replaced)
	db ICON_HITMONTOP   ; HITMONTOP
;	db ICON_SMOOCHUM    ; SMOOCHUM
	db ICON_MAGNEZONE   ; MAGNEZONE ;MAGNEZONE
;	db ICON_ELEKID      ; ELEKID
	db ICON_TANGROWTH   ; TANGROWTH ;TANGROWTH
;	db ICON_MAGBY       ; MAGBY
	db ICON_LEAFEON     ; LEAFEON ;LEAFEON
	db ICON_GLACEON     ; GLACEON ;GLACEON
	...
	db ICON_MISSINGNO   ; MISSINGNO ;MISSINGNO
	db ICON_EGG         ; EGG
