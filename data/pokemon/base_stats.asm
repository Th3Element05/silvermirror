...
INCLUDE "data/pokemon/base_stats/cleffa.asm"    ;remove
INCLUDE "data/pokemon/base_stats/igglybuff.asm" ;remove
INCLUDE "data/pokemon/base_stats/togepi.asm"    ;remove
INCLUDE "data/pokemon/base_stats/togetic.asm"   ;remove
...
INCLUDE "data/pokemon/base_stats/yanmega.asm" ;NEW
...
INCLUDE "data/pokemon/base_stats/delibird.asm" ;remove
...
INCLUDE "data/pokemon/base_stats/smoochum.asm" ;remove
;INCLUDE "data/pokemon/base_stats/magnezone.asm"
INCLUDE "data/pokemon/base_stats/elekid.asm"   ;remove
;INCLUDE "data/pokemon/base_stats/tangrowth.asm"
INCLUDE "data/pokemon/base_stats/magby.asm"    ;remove
...
INCLUDE "data/pokemon/base_stats/missingno.asm" ;missingno
