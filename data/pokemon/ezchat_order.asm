...
.hi_bi_pi: db CLEFFA, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
...
.ya:       db SLOWKING, SLOWBRO, SLOWPOKE, MURKROW, YANMA, YANMEGA, -1
.yu:       db KADABRA, -1
