...
;	dw NULL, NULL ; unused (beta front/back pics)
	...
	; tm/hm learnset
	tmhm DARK_PULSE, TOXIC, BODY_SLAM, DOUBLE_EDGE, COUNTER, SOLARBEAM, DIG, DOUBLE_TEAM, BIDE, FIRE_BLAST, SWIFT, DREAM_EATER, REST, SUBSTITUTE, FLAMETHROWER, HEADBUTT, CURSE, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, ENDURE, IRON_TAIL, SHADOW_BALL, MUD_SLAP, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, FIRE_BLAST, ATTRACT, THIEF, NIGHTMARE, FLAMETHROWER
