...
;tmhm HEADBUTT, CURSE, TOXIC, BRICK_BREAK, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, ENDURE, IRON_TAIL, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, SANDSTORM, SWIFT, REST, ATTRACT, THIEF, CUT, STRENGTH
	; end
;RAZOR_WIND
;MIMIC
;CUT
