...
;	dw NULL, NULL ; unused (beta front/back pics)
	...
	; tm/hm learnset
	tmhm DARK_PULSE, TOXIC, BODY_SLAM, DOUBLE_EDGE, DIG, DOUBLE_TEAM, REFLECT, BIDE, SWIFT, REST, SUBSTITUTE, FLAMETHROWER, HEADBUTT, CURSE, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, ENDURE, IRON_TAIL, SWAGGER, SLEEP_TALK, FIRE_BLAST, ATTRACT
