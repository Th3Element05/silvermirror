...
;	dw NULL, NULL ; unused (beta front/back pics)
	...
	; tm/hm learnset
	tmhm SWORDS_DANCE, TOXIC, HORN_DRILL, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, BUBBLEBEAM, WATER_GUN, ICE_BEAM, BLIZZARD, HYPER_BEAM, PAY_DAY, SUBMISSION, COUNTER, SEISMIC_TOSS, RAGE, GIGA_DRAIN, SOLARBEAM, THUNDERBOLT, THUNDER, EARTHQUAKE, FISSURE, DIG, PSYCHIC_M, TELEPORT, DOUBLE_TEAM, REFLECT, BIDE, METRONOME, SELFDESTRUCT, FIRE_BLAST, SWIFT, SOFTBOILED, DREAM_EATER, SKY_ATTACK, REST, THUNDER_WAVE, ROCK_SLIDE, TRI_ATTACK, SUBSTITUTE, FLAMETHROWER, DYNAMICPUNCH, FALSE_SWIPE, HEADBUTT, CURSE, ROLLOUT, SPARK, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SWEET_SCENT, SNORE, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, IRON_TAIL, DRAGONBREATH, SHADOW_BALL, MUD_SLAP, ICE_PUNCH, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, SANDSTORM, FIRE_BLAST, THUNDERPUNCH, ATTRACT, THIEF, STEEL_WING, FIRE_PUNCH, FURY_CUTTER, NIGHTMARE, CUT, FLY, SURF, STRENGTH, FLASH, WHIRLPOOL, WATERFALL, FLAMETHROWER, THUNDERBOLT, ICE_BEAM, ANCIENTPOWER
