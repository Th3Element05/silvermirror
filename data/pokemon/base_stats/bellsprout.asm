...
;	dw NULL, NULL ; unused (beta front/back pics)
	...
	; tm/hm learnset
	tmhm BULLET_SEED, ENERGY_BALL, SWORDS_DANCE, TOXIC, DOUBLE_EDGE, GIGA_DRAIN, SOLARBEAM, DOUBLE_TEAM, REFLECT, BIDE, REST, SUBSTITUTE, FALSE_SWIPE, CURSE, HIDDEN_POWER, SUNNY_DAY, SWEET_SCENT, SNORE, PROTECT, ENDURE, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, ATTRACT
