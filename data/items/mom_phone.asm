...
MomItems_2:
	...
	momitem   7000, 0, MOM_DOLL, DECO_SQUIRTLE_DOLL
	momitem  10000, 0, MOM_DOLL, DECO_PIKACHU_DOLL
	momitem  13000, 0, MOM_DOLL, DECO_GEODUDE_DOLL
	momitem  16000, 0, MOM_DOLL, DECO_CLEFAIRY_DOLL
	momitem  19000, 0, MOM_DOLL, DECO_JIGGLYPUFF_DOLL
	momitem  22000, 0, MOM_DOLL, DECO_ODDISH_DOLL
	momitem  25000, 0, MOM_DOLL, DECO_DIGLETT_DOLL
	momitem  28000, 0, MOM_DOLL, DECO_MACHOP_DOLL
	momitem  31000, 0, MOM_DOLL, DECO_GRIMER_DOLL
	momitem  34000, 0, MOM_DOLL, DECO_VOLTORB_DOLL
	momitem  37000, 0, MOM_DOLL, DECO_GENGAR_DOLL
	momitem  40000, 0, MOM_DOLL, DECO_MAGIKARP_DOLL
	momitem  43000, 0, MOM_DOLL, DECO_POLIWAG_DOLL
	momitem  46000, 0, MOM_DOLL, DECO_SHELLDER_DOLL
	momitem  49000, 0, MOM_DOLL, DECO_STARYU_DOLL
	momitem  52000, 0, MOM_DOLL, DECO_BIG_ONIX_DOLL
	momitem  55000, 0, MOM_DOLL, DECO_BIG_SNORLAX_DOLL
