...
MomItems_2:
	momitem   4000, 0, MOM_DOLL, DECO_BULBASAUR_DOLL
	momitem   4000, 0, MOM_DOLL, DECO_CHARMANDER_DOLL
	momitem   4000, 0, MOM_DOLL, DECO_SQUIRTLE_DOLL
	momitem   4000, 0, MOM_DOLL, DECO_PIKACHU_DOLL
	momitem   8000, 0, MOM_DOLL, DECO_GEODUDE_DOLL
	momitem   8000, 0, MOM_DOLL, DECO_CLEFAIRY_DOLL
	momitem   8000, 0, MOM_DOLL, DECO_JIGGLYPUFF_DOLL
	momitem  12000, 0, MOM_DOLL, DECO_ODDISH_DOLL
	momitem  12000, 0, MOM_DOLL, DECO_DIGLETT_DOLL
	momitem  12000, 0, MOM_DOLL, DECO_MACHOP_DOLL
	momitem  16000, 0, MOM_DOLL, DECO_GRIMER_DOLL
	momitem  16000, 0, MOM_DOLL, DECO_VOLTORB_DOLL
	momitem  16000, 0, MOM_DOLL, DECO_GENGAR_DOLL
	momitem  20000, 0, MOM_DOLL, DECO_MAGIKARP_DOLL
	momitem  20000, 0, MOM_DOLL, DECO_POLIWAG_DOLL
	momitem  20000, 0, MOM_DOLL, DECO_SHELLDER_DOLL
	momitem  20000, 0, MOM_DOLL, DECO_STARYU_DOLL
	momitem  40000, 0, MOM_DOLL, DECO_BIG_ONIX_DOLL
	momitem  40000, 0, MOM_DOLL, DECO_BIG_SNORLAX_DOLL
	momitem  40000, 0, MOM_DOLL, DECO_BIG_LAPRAS_DOLL
	momitem  48000, 0, MOM_ITEM, PP_UP
	momitem  48000, 0, MOM_ITEM, MOON_STONE
