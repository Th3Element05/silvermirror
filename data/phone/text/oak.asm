...
OakPhoneSSAnneText:
	...
	line "while its docked!"

	para "I'm sure you will"
	line "see some rare"
	cont "#MON there!"

	para "It will be good"
	line "for filling up"
	cont "your #DEX!"
	done

OakPhoneRemindSSAnneText:
	text "Hellow, <PLAYER>?"

	para "S.S.ANNE is still"
	line "at VERMILION CITY!"

	para "You should check"
	line "it out before it"
	cont "sets sail again!"
	done

OakPhoneGetFlashText:
	text "Hello, <PLAYER>?"
