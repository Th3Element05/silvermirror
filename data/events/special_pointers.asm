...
; Map events
	...
	add_special RevealHiddenPower ;UnusedMemoryGame ; unused
	...
	add_special ShowPokedexEntry ; silvermirror+
	add_special SilentSetSeenMon ; silvermirror+ ; UnusedSetSeenMon
