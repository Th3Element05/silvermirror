...
;(see constants\wram_constants.asm)
	...
	engine_flag wStatusFlags, STATUSFLAGS_ROCKET_SIGNAL_F            ;unused
	engine_flag wStatusFlags, STATUSFLAGS_HALL_OF_FAME_F
	engine_flag wStatusFlags, STATUSFLAGS_MAIN_MENU_MOBILE_CHOICES_F ;unused
	...
	engine_flag wStatusFlags2, STATUSFLAGS2_BLUE_IN_VIRIDIAN_GYM_F
	engine_flag wStatusFlags2, STATUSFLAGS2_BIKE_SHOP_CALL_F         ;unused
	engine_flag wStatusFlags2, STATUSFLAGS2_ROCKETS_SILPH_CO_F
	engine_flag wStatusFlags2, STATUSFLAGS2_REACHED_GOLDENROD_F
	engine_flag wStatusFlags2, STATUSFLAGS2_CAN_USE_WATERFALL_F
...
;	engine_flag wDailyFlags1, DAILYFLAGS_FUCHSIA_APRICORN
	...
	engine_flag wDailyFlags2, DAILYFLAGS2_ENGINE_RODE_SSAQUA_TODAY_F ;GOLDENROD_DEPT_STORE_TM71_RETURN_F
