InitialEvents:
	dw EVENT_PALLET_TOWN_OAK ;silvermirror+
	dw EVENT_OAKS_LAB_OAK ;silvermirror+
	dw EVENT_ROUTE_22_RIVAL ;silvermirror+
	dw EVENT_CERULEAN_CITY_RIVAL ;silvermirror+
	dw EVENT_SSANNE_2F_RIVAL ;silvermirror+
...
;	dw EVENT_ROUTE_16_TM_SLEEP_TALK ;silvermirror+
	...
	dw EVENT_SEAFOAM_B2F_BOULDER_2 ;silvermirror+
	dw EVENT_SEAFOAM_B3F_BOULDER_X1 ;silvermirror+
	dw EVENT_SEAFOAM_B3F_BOULDER_X2 ;silvermirror+
	dw EVENT_SEAFOAM_B4F_BOULDER_X1 ;silvermirror+
	dw EVENT_SEAFOAM_B4F_TM_ICE_BEAM ;silvermirror+
	dw EVENT_POWER_PLANT_TM_THUNDERBOLT ;silvermirror+
	dw EVENT_VICTORY_ROAD_2F_TM_FLAMETHROWER ;silvermirror+
	dw EVENT_SAFFRON_CITY_CIVILIANS ;silvermirror+
	dw EVENT_CINNABAR_LAB_HELIX_FOSSIL ;silvermirror+
	dw EVENT_CINNABAR_LAB_DOME_FOSSIL ;silvermirror+
	dw EVENT_CINNABAR_LAB_OLD_AMBER ;silvermirror+
	dw EVENT_VICTORY_ROAD_2F_BOULDER2 ;silvermirror+
	dw EVENT_LANCES_ROOM_RIVAL ;silvermirror+
	dw EVENT_LANCES_ROOM_OAK ;silvermirror+
