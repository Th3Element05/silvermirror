; MonMenuOptionStrings indexes
	...
	const MONMENUVALUE_FLY    ; 8
	const MONMENUVALUE_FLASH  ; 9
...
;	db MONMENU_FIELD_MOVE, MONMENUITEM_MILKDRINK,  MILK_DRINK ;removed
...
; options
	...
	db MONMENU_MENUOPTION, MONMENUITEM_FLY,        MONMENUVALUE_FLY
	db MONMENU_MENUOPTION, MONMENUITEM_FLASH,      MONMENUVALUE_FLASH
	assert_table_length NUM_MONMENUITEMS ;- 1 ; disregard FLY
	db -1 ; end
