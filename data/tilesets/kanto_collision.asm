	...
	tilecoll WALL, WALL, WATER, WATER ; 09
	...
	tilecoll WALL, UP_WALL, WALL, FLOOR ; cc
	tilecoll UP_WALL, WALL, FLOOR, WALL ; cd
	tilecoll WALL, UP_WALL, WALL, FLOOR ; ce
	tilecoll UP_WALL, WALL, FLOOR, WALL ; cf
