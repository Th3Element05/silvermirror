...
;	     MOVE,         EFFECT,                 POWER, TYPE,         CATEGORY, ACC, PP, EFFECT%
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          20, NORMAL,       PHYSICAL,  85, 10,   0 ; OLD POW:15
	...
	move AIR_SLICE,    EFFECT_FLINCH_HIT,         70, FLYING,       SPECIAL,   95, 15,  20 ;RAZOR_WIND, removed
	...
	move POISON_STING, EFFECT_POISON_HIT,         20, POISON,       PHYSICAL, 100, 35,  30 ; OLD POW:15
	move POISON_TAIL,  EFFECT_POISON_HIT,         50, POISON,       PHYSICAL, 100, 25,  10 ;TWINEEDLE, removed
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          25, BUG,          PHYSICAL,  95, 20,   0 ; OLD POW:14
	...
	move GROWTH,       EFFECT_SP_ATK_UP,           0, GRASS,        STATUS,   100, 20,   0
	...
	move ROCK_POLISH,  EFFECT_SPEED_UP_2,          0, ROCK,         STATUS,   100, 20,   0 ;DRAGON_RAGE, replaced
	...
	move SMOG,         EFFECT_POISON_HIT,         30, POISON,       SPECIAL,   90, 20,  50 ; OLD ACC:70 %:40
...
;	move BONE_CLUB,    EFFECT_FLINCH_HIT,         65, GROUND,       PHYSICAL,  85, 20,  10
	...
	move WATERFALL,    EFFECT_FLINCH_HIT,         80, WATER,        PHYSICAL, 100, 15,  20 ; OLD EFFECT_NORMAL_HIT
	...
	move ROCK_BLAST,   EFFECT_MULTI_HIT,          25, ROCK,         PHYSICAL,  90, 10,   0 ;FURY_SWIPES, removed
	...
	move HONE_CLAWS,   EFFECT_HONE_CLAWS,          0, NORMAL,       STATUS,   100, 30,   0 ;SHARPEN, removed
...
;	move NIGHTMARE,    EFFECT_NIGHTMARE,           0, GHOST,        STATUS,   100, 15,   0
	...
	move WHIRLWIND,    EFFECT_FORCE_SWITCH,        0, FLYING,       STATUS,   100, 20,   0 ;MORNING_SUN, removed
;	move MORNING_SUN,  EFFECT_MORNING_SUN,         0, NORMAL,       STATUS,   100,  5,   0
	...
	move HIDDEN_POWER, EFFECT_HIDDEN_POWER,       60, CURSE_TYPE,   SPECIAL,  100, 15,   0
