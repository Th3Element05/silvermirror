...
;TyrogueFrontpic:     INCBIN "gfx/pokemon/tyrogue/front.animated.2bpp.lz" ; removed (not replaced)
...
;TyrogueBackpic:      INCBIN "gfx/pokemon/tyrogue/back.2bpp.lz" ; removed (not replaced)
