...
YanmegaIcon::    INCBIN "gfx/icons/yanmega.2bpp" ;YANMEGA
...
HonchkrowIcon::  INCBIN "gfx/icons/honchkrow.2bpp" ;HONCHKROW
SlowkingIcon::   INCBIN "gfx/icons/slowking.2bpp"
MisdreavusIcon:: INCBIN "gfx/icons/misdreavus.2bpp"
MismagiusIcon::  INCBIN "gfx/icons/mismagius.2bpp" ;MISMAGIUS
...
GliscorIcon::    INCBIN "gfx/icons/gliscor.2bpp" ;GLISCOR
...
WeavileIcon::    INCBIN "gfx/icons/weavile.2bpp" ;WEAVILE
...
MamoswineIcon::  INCBIN "gfx/icons/mamoswine.2bpp" ;MAMOSWINE
...
MagnezoneIcon::  INCBIN "gfx/icons/magnezone.2bpp" ;MAGNEZONE
;ElekidIcon::     INCBIN "gfx/icons/elekid.2bpp"
TangrowthIcon::  INCBIN "gfx/icons/tangrowth.2bpp" ;TANGROWTH
;MagbyIcon::      INCBIN "gfx/icons/magby.2bpp"
LeafeonIcon::  INCBIN "gfx/icons/leafeon.2bpp" ;LEAFEON
GlaceonIcon::  INCBIN "gfx/icons/glaceon.2bpp" ;GLACEON
...
MissingnoIcon::  INCBIN "gfx/icons/missingno.2bpp" ;MISSINGNO
