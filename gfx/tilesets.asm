...
TilesetRocketFacilityGFX::
INCBIN "gfx/tilesets/rocket_facility.2bpp.lz"

TilesetRocketFacilityMeta::
INCBIN "data/tilesets/rocket_facility_metatiles.bin"

TilesetRocketFacilityColl::
INCLUDE "data/tilesets/rocket_facility_collision.asm"

TilesetCemetaryGFX::
INCBIN "gfx/tilesets/cemetary.2bpp.lz"

TilesetCemetaryMeta::
INCBIN "data/tilesets/cemetary_metatiles.bin"

TilesetCemetaryColl::
INCLUDE "data/tilesets/cemetary_collision.asm"
