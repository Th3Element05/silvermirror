	...
	tilepal 0, WATER, WATER, GREEN, GREEN, WATER, BROWN, BROWN, GRAY
	tilepal 0, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, WATER
	tilepal 0, WATER, WATER, GREEN, GREEN, WATER, BROWN, BROWN, BROWN
	...
	tilepal 1, WATER, WATER, ROOF, GRAY, GRAY, GRAY, GRAY, WATER
	tilepal 1, WATER, GRAY, GRAY, BROWN, BROWN, GRAY, GRAY, GRAY
