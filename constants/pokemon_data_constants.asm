...
;DEF NUM_GRASSMON EQU 7 ; data/wild/*_grass.asm table size ;silvermirror- EXPAND encounter tables
;DEF NUM_WATERMON EQU 3 ; data/wild/*_water.asm table size ;silvermirror- EXPAND encounter tables
...
;	const TREEMON_SET_MT_SILVER
	...
	const TREEMON_SET_ROUTE
	const TREEMON_SET_FOREST
	const TREEMON_SET_YANMA
	const TREEMON_SET_MT_SILVER
	const TREEMON_SET_ROCK
	const TREEMON_SET_SEA_ROCK_KANTO
	const TREEMON_SET_SEA_ROCK_JOHTO
	const TREEMON_SET_FIRE_ROCK
	const TREEMON_SET_POISON_ROCK
...
; Dynamic Levels
DEF BADGE_LEVEL EQU 250
DEF PLAYER_LEVEL EQU 220
DEF MIN_DYNAMIC_LEVEL EQU 50
