...
;DEF GRASS_WILDDATA_LENGTH EQU 2 + 3 + NUM_GRASSMON * 2 * 3 ;silvermirror- custom encounter probabilities
;DEF WATER_WILDDATA_LENGTH EQU 2 + 1 + NUM_WATERMON * 2     ;silvermirror- custom encounter probabilities
DEF GRASS_WILDDATA_LENGTH EQU 2 + 3 + NUM_GRASSMON * 4 * 3  ;silvermirror+ custom encounter probabilities
DEF WATER_WILDDATA_LENGTH EQU 2 + 1 + NUM_WATERMON * 4      ;silvermirror+ custom encounter probabilities
