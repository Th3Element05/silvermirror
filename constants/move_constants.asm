...
; - BattleAnimations (see data/moves/animations.asm)
	...
	const ROCK_POLISH  ; 52 ;DRAGON_RAGE, removed
	const FIRE_SPIN    ; 53
	...
	const ROCK_SLIDE   ; 9d
	const HYPER_FANG   ; 9e
	const HONE_CLAWS   ; 9f ;SHARPEN, removed
	const CONVERSION   ; a0
	const TRI_ATTACK   ; a1
	const SUPER_FANG   ; a2
	const SLASH        ; a3
...
; Battle animations use the same constants as the moves up to this point
	...
	const ANIM_HELD_ITEM_TRIGGER ; 100
...
; battle anims
	...
	const ANIM_SAFARI_THROW_ROCK ; 119
	const ANIM_SAFARI_THROW_BAIT ; 11a
