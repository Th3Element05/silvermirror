...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const ROUTE_42_ECRUTEAK_GATE,                       4,  5 ;  4 ; 5,  4 ;  4
	...
	newgroup DUNGEONS                                             ;  3
; kanto
	map_const MOUNT_MOON,                                  20, 27 ; 85 ; 15,  9 ; 85
	map_const MOUNT_MOON_B2F,                              20, 18 ; 85
	map_const UNDERGROUND_PATH,                             3, 14 ; 86
	map_const DIGLETTS_CAVE,                               19, 17 ; 84
	map_const ROCK_TUNNEL_1F,                              18, 16 ; 87 ; 15, 18 ; 87
	map_const ROCK_TUNNEL_B1F,                             18, 16 ; 88 ; 15, 18 ; 88
	map_const UNDERGROUND_PATH_EW,                         16,  3 ; 86
	map_const ROCKET_HIDEOUT_B1F,                          11, 12 ; 27
	map_const ROCKET_HIDEOUT_B2F,                          15, 11 ; 28
	map_const ROCKET_HIDEOUT_B3F,                          11, 12 ; 29
	map_const ROCKET_HIDEOUT_B4F,                          11, 12 ; 30
	map_const ROCKET_HIDEOUT_ELEVATOR,                      2,  2 ; 31
	map_const POKEMON_TOWER_1F,                             9,  9 ; 15
	map_const POKEMON_TOWER_2F,                             9,  9 ; 16
	map_const POKEMON_TOWER_3F,                             9,  9 ; 17
	map_const POKEMON_TOWER_4F,                             9,  9 ; 18
	map_const POKEMON_TOWER_5F,                             9,  9 ; 19
	map_const POKEMON_TOWER_6F,                             9,  9 ; 20
	map_const POKEMON_TOWER_7F,                             9,  9 ; 21
	map_const SILPH_CO_1F,                                 15,  9 ;  1
	map_const SILPH_CO_2F,                                 15,  9 ;  1
	map_const SILPH_CO_3F,                                 15,  9 ;  1
	map_const SILPH_CO_4F,                                 15,  9 ;  1
	map_const SILPH_CO_5F,                                 15,  9 ;  1
	map_const SILPH_CO_6F,                                 13,  9 ;  1
	map_const SILPH_CO_7F,                                 13,  9 ;  1
	map_const SILPH_CO_8F,                                 13,  9 ;  1
	map_const SILPH_CO_9F,                                 13,  9 ;  1
	map_const SILPH_CO_10F,                                 8,  9 ;  1
	map_const SILPH_CO_11F,                                 9,  9 ;  1
	...
	map_const SEAFOAM_ISLANDS_B3F,                         15, 10 ;  8 ; 21, 13 ;  8
	map_const SEAFOAM_ISLANDS_B4F,                         15, 10 ;  9 ; 21, 13 ;  9
	map_const POKEMON_MANSION_1F,                          15, 14 ; 14
	map_const POKEMON_MANSION_2F,                          15, 14 ; 16
	map_const POKEMON_MANSION_3F,                          15,  9 ; 17
	map_const POKEMON_MANSION_B1F,                         15, 14 ; 15
...
;	map_const RUINS_OF_ALPH_AERODACTYL_WORD_ROOM,          10,  7 ; 36
	...
	map_const DARK_CAVE_BLACKTHORN_ENTRANCE,               17, 18 ; 79
...
;	map_const CLIFF_CAVE,                                   7, 20 ; 93
	...
	map_const BLACKTHORN_MART,                              5,  4 ;  4
	map_const BLACKTHORN_POKECENTER_1F,                     7,  4 ;  5
...
;	map_const SEAFOAM_GYM,                                 12, 11 ;  4
	map_const ROUTE_19,                                    10, 25 ; 10
	map_const ROUTE_20,                                    45,  9 ; 11 ; 42,  9 ; 11
...
;	map_const ROUTE_10_POKECENTER_2F_BETA,                  8,  4 ;  9
	...
	map_const ROUTE_4,                                     40,  9 ; 12 ; 30,  9 ; 12
	map_const ROUTE_9,                                     30,  9 ; 13
	map_const ROUTE_10_NORTH,                              10, 15 ; 14 ; 10, 16 ; 14
	map_const ROUTE_24,                                    11, 18 ; 15 ; 11,  9 ; 15
	map_const ROUTE_25,                                    27,  9 ; 16 ; 38,  9 ; 16
...
;silvermirror moved
	...
	map_const ROUTE_43_MAHOGANY_GATE,                       4,  4 ;  3 ; 5,  4 ;  3
	map_const ROUTE_43_GATE,                                4,  4 ;  4 ; 5,  4 ;  4
	...
	map_const ROUTE_32_RUINS_OF_ALPH_GATE,                  4,  5 ; 12 ; 5,  4 ; 12
	map_const ROUTE_32_POKECENTER_1F,                       7,  4 ; 13
	map_const ROUTE_35_GOLDENROD_GATE,                      4,  4 ; 14 ; 5,  4 ; 14
	map_const ROUTE_35_NATIONAL_PARK_GATE,                  4,  4 ; 15
	map_const ROUTE_36_RUINS_OF_ALPH_GATE,                  4,  4 ; 16 ; 5,  4 ; 16
...
;	map_const POKECOM_CENTER_ADMIN_OFFICE_MOBILE,          16, 16 ; 21
	map_const ILEX_FOREST_AZALEA_GATE,                      4,  5 ; 22 ; 5,  4 ; 22
	map_const ROUTE_34_ILEX_FOREST_GATE,                    4,  4 ; 23 ; 5,  4 ; 23
;	map_const DAY_CARE,                                     5,  4 ; 24
	endgroup

	newgroup VERMILION                                            ; 12
	map_const ROUTE_6,                                     10, 16 ;  1 ; 12, 15 ;  1
	map_const ROUTE_11,                                    27,  9 ;  2 ; 26,  9 ;  2 ; 28,  9 ;  2
	map_const VERMILION_CITY,                              20, 18 ;  3 ; 20, 20 ;  3
...
;	map_const PEWTER_POKECENTER_2F_BETA,                    8,  4 ;  7
	...
	map_const MOUNT_MOON_POKECENTER_1F,                     7,  4 ; 11
;	map_const ROUTE_2,                                     10, 32 ; 12
	map_const ROUTE_2_NUGGET_HOUSE,                         4,  4 ; 11
	map_const ROUTE_2_NORTH,                               10, 18 ; 12 ; 12, 19 ; 12
	map_const VIRIDIAN_FOREST,                             17, 28 ; 14
	map_const VIRIDIAN_FOREST_GATE_N,                       4,  4 ; 15 ; 5,  4 ; 15
	map_const VIRIDIAN_FOREST_GATE_S,                       4,  4 ; 16 ; 5,  4 ; 16
	endgroup

	newgroup SS_ANNE ; FAST_SHIP                                  ; 15
	map_const OLIVINE_PORT,                                10, 18 ;  1
	map_const VERMILION_PORT,                              10,  9 ;  2
	map_const SS_ANNE_1F,                                  19,  8 ;  3 ;silvermirror
	map_const SS_ANNE_ROOMS_1F,                            17,  3 ;  8 ;silvermirror
	map_const SS_ANNE_ROOMS_B1F,                           17,  3 ;  8 ;silvermirror
	map_const SS_ANNE_KITCHEN,                              7,  7 ;  7 ;silvermirror
	map_const SS_ANNE_2F,                                  19,  8 ;  4 ;silvermirror
	map_const SS_ANNE_ROOMS_2F,                            17,  3 ;  8 ;silvermirror
	map_const SS_ANNE_BOW,                                 10,  7 ;  5 ;silvermirror
;	map_const SS_ANNE_CAPTAINS_ROOM,                        3,  4 ;  6 ;silvermirror
...
;	map_const VERMILION_PORT_PASSAGE,                      10,  9 ;  9
	...
	newgroup INDIGO                                               ; 16
	map_const ROUTE_23,                                    10, 36 ;  1 ; 10,  9 ;  1
	map_const INDIGO_PLATEAU_POKECENTER_1F,                 9,  6 ;  2
...
;	map_const MOBILE_BATTLE_ROOM,                           5,  4 ;  6
	...
	newgroup CELADON                                              ; 21
	map_const ROUTE_7,                                     10, 10 ;  1 ; 10,  9 ;  1
...
;	map_const CELADON_DEPT_STORE_6F,                        8,  4 ; 10
	map_const CELADON_DEPT_STORE_ROOF,                      8,  6 ; 10
...
;silvermirror+
	map_const CELADON_CHIEF_HOUSE,                          4,  4 ; 26
	map_const CELADON_HOTEL,                                7,  4 ; 27
	endgroup
	...
	map_const ROUTE_40_BATTLE_TOWER_GATE,                   4,  4 ; 15 ; 5,  4 ; 15
...
;	map_const VIRIDIAN_POKECENTER_2F_BETA,                  8,  4 ; 10
	map_const ROUTE_2_GATE,                                 4,  4 ; 12 ; 5,  4 ; 12
	map_const VICTORY_ROAD_GATE,                           10,  8 ; 13 ; 10,  9 ; 13
;silvermirror
	map_const ROUTE_26_GATE,                                4,  4 ; 14
	map_const ROUTE_27_EAST,                               26,  9 ;  2
;silvermirror moved
...
;	map_const ROUTE_27,                                    40,  9 ;  2
	map_const ROUTE_27_WEST,                               18,  9 ;  2
...
;	map_const ROUTE_27_SANDSTORM_HOUSE,                     4,  4 ; 12
	map_const ROUTE_29_ROUTE_46_GATE,                       4,  4 ; 13 ; 5,  4 ; 13
;silvermirror moved
	map_const REDS_HOUSE_1F,                                4,  4 ;  3
	map_const REDS_HOUSE_2F,                                4,  4 ;  4
	endgroup
...
;	map_const SILPH_CO_1F,                                  8,  4 ; 10
	...
	map_const ROUTE_5_SAFFRON_GATE,                         4,  4 ; 14 ; 5,  4 ; 14
;	map_const ROUTE_5_CLEANSE_TAG_HOUSE,                    4,  4 ; 15
;silvermirror moved
	map_const DAY_CARE,                                     4,  4 ; 24 ; 5,  4 ; 24
	endgroup
	...
	map_const CHERRYGROVE_MART,                             5,  4 ;  4
	...
	map_const ROUTE_31_VIOLET_GATE,                         4,  5 ; 11 ; 5,  4 ; 11
	endgroup
...
;	map_const SAFARI_ZONE_GATE_POKECENTER_1F,               7,  4 ;  5
	endgroup
