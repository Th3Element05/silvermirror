...
; wStatusFlags::
	...
	const STATUSFLAGS_ROCKET_SIGNAL_F            ; 4 ;unused
	const STATUSFLAGS_NO_WILD_ENCOUNTERS_F       ; 5
	const STATUSFLAGS_HALL_OF_FAME_F             ; 6
	const STATUSFLAGS_MAIN_MENU_MOBILE_CHOICES_F ; 7 ;unused

; wStatusFlags2::
	const_def
	const STATUSFLAGS2_BUG_CONTEST_TIMER_F      ; 0
	const STATUSFLAGS2_SAFARI_GAME_F            ; 1
	const STATUSFLAGS2_ROCKETS_IN_RADIO_TOWER_F ; 2
	const STATUSFLAGS2_BLUE_IN_VIRIDIAN_GYM_F   ; 3
	const STATUSFLAGS2_BIKE_SHOP_CALL_F         ; 4 ;unused
	const STATUSFLAGS2_ROCKETS_SILPH_CO_F       ; 5
	const STATUSFLAGS2_REACHED_GOLDENROD_F      ; 6
	const STATUSFLAGS2_CAN_USE_WATERFALL_F      ; 7
...
; wDailyFlags2::
	...
	const DAILYFLAGS2_ENGINE_RODE_SSAQUA_TODAY_F          ; 3 ;GOLDENROD_DEPT_STORE_TM71_RETURN_F  ; 3
