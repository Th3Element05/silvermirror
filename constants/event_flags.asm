...
; Story events (silvermirror)
	...
	const EVENT_MOM_CALLED_ABOUT_LEADER_BLUE
...
; The map script command macros `setevent` and `clearevent` set/clear these flags, and their effects will be seen when the map is reloaded.
	...
	const EVENT_HALL_OF_FAME_OAK
	const EVENT_HALL_OF_FAME_LANCE
	const EVENT_KANTO_LEADER_REMATCHES
	const EVENT_VIRIDIAN_GYM_BLUE
	const EVENT_MT_MOON_SQUARE_ROCK
	const EVENT_MT_MOON_SQUARE_CLEFAIRY
	const EVENT_TELEPORT_GUY ;unused
...
; Kanto Rematches
	const EVENT_BEAT_BROCK_2
	const EVENT_BEAT_MISTY_2
	const EVENT_BEAT_LTSURGE_2
	const EVENT_BEAT_ERIKA_2
	const EVENT_BEAT_KOGA_2
	const EVENT_BEAT_SABRINA_2
	const EVENT_BEAT_BLAINE_2
	const EVENT_BEAT_LEADER_BLUE
; Johto Rematches
;	const EVENT_BEAT_FALKNER_2
;	const EVENT_BEAT_BUGSY_2
;	const EVENT_BEAT_WHITNEY_2
;	const EVENT_BEAT_MORTY_2
;	const EVENT_BEAT_CHUCK_2
;	const EVENT_BEAT_JASMINE_2
;	const EVENT_BEAT_PRYCE_2
;	const EVENT_BEAT_CLAIR_2
; Mt Silver
...
; Pokemaniac
	...
	const EVENT_BEAT_POKEMANIAC_TYSON
