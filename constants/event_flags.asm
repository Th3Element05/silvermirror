...
; Got stuff Kanto
	...
	const EVENT_GOT_POKEMON_FROM_DOJO_2
...
; The map script command macros `setevent` and `clearevent` set/clear these flags, and their effects will be seen when the map is reloaded.
	...
	const EVENT_OAKS_LAB_OAK_REMATCH
...
; The map script command macros `setevent` and `clearevent` set/clear these flags, and their effects will be seen when the map is reloaded.
	...
	const EVENT_NINJA_SECURITY_SHOW_SHINE
...
; The map script command macros `setevent` and `clearevent` set/clear these flags, and their effects will be seen when the map is reloaded.
	...
	const EVENT_SAFARI_ZONE_AREA_1_TM_WILL_O_WISP
	...
	const EVENT_BILLS_BACK_YARD_SUN_STONE
	const EVENT_BILLS_BACK_YARD_DUSK_STONE
; used 147
; running total used 747
;
; Johto itemballs
; Sprite visibility flags
; When these events are cleared, the sprite becomes visible; when set, the sprite is hidden.
...
;	const EVENT_ROUTE_42_ULTRA_BALL
	...
	const EVENT_GOLDENROD_DEPT_STORE_B1F_PP_UP
...
; Kanto hidden items (silvermirror)
	...
	const EVENT_SAFARI_ZONE_SOUTH_HIDDEN_NUGGET            ;new in silvermirror
...
; Blackbelt
	...
	const EVENT_BEAT_BLACKBELT_MASTER_REMATCH
...
; Berries and Apricorns
	...
	const EVENT_ROUTE_2_PNK_APRICORN
