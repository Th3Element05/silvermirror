...
; Johto Gym Leader TM gifts
	...
	const EVENT_GOT_TM75_FURY_CUTTER
	const EVENT_GOT_TM43_SKY_ATTACK
	const EVENT_GOT_TM77_ANCIENTPOWER
	const_skip ;HM-whirlpool?
	const EVENT_GOT_TM23_DRAGONBREATH
; used 8
...
;	const EVENT_GOT_TM53_ICY_WIND
	const EVENT_GOT_TM55_HEADBUTT ; ilex forest, sooner?
	const EVENT_GOT_TM58_HIDDEN_POWER
	const EVENT_GOT_TM59_SUNNY_DAY
	const EVENT_GOT_TM61_SNORE
	const EVENT_GOT_TM63_RAIN_DANCE
	const EVENT_GOT_TM64_ENDURE
	const EVENT_GOT_TM68_SWAGGER ; dance theater
	const EVENT_GOT_TM69_SLEEP_TALK
	const EVENT_GOT_TM71_SANDSTORM
	const_skip ; unused
; used 21
...
; Johto / postgame
	...
	const EVENT_PASSED_NINJA_CHALLENGE
...
; The map script command macros `setevent` and `clearevent` set/clear these flags, and their effects will be seen when the map is reloaded.
	...
	const EVENT_MT_MOON_TM12_WATER_GUN
	...
	const EVENT_ROCKET_HIDEOUT_B2F_TM_HORN_DRILL
	...
	const EVENT_ROUTE_16_SHARP_BEAK
	const EVENT_ROUTE_16_TM_SLEEP_TALK
	...
	const EVENT_SAFARI_ZONE_AREA_2_TM_EGG_BOMB
	const EVENT_SAFARI_ZONE_AREA_2_CARBOS
	const EVENT_SAFARI_ZONE_AREA_3_PROTEIN
	const EVENT_SAFARI_ZONE_AREA_3_TM_SKULL_BASH
	const EVENT_SAFARI_ZONE_AREA_4_TM_DOUBLE_TEAM
...
;	const EVENT_VICTORY_ROAD_1F_TM_SKY_ATTACK
	const EVENT_VICTORY_ROAD_1F_TM_SLUDGE_BOMB ;replaces sky attack
	const EVENT_VICTORY_ROAD_1F_RARE_CANDY
	const EVENT_VICTORY_ROAD_2F_GUARD_SPEC
	const EVENT_VICTORY_ROAD_2F_TM_SUBMISSION
	const EVENT_VICTORY_ROAD_2F_FULL_HEAL
	const EVENT_VICTORY_ROAD_2F_TM_MEGA_KICK
	const EVENT_VICTORY_ROAD_3F_TM_EXPLOSION
...
;	const EVENT_MOUNT_MORTAR_2F_INSIDE_TM_DEFENSE_CURL
	...
	const EVENT_ICE_PATH_B2F_BLACKTHORN_SIDE_ICE_HEAL
...
;	const EVENT_SILVERCAVEITEMROOMS_HIDDEN_HYPER_POTION
;	const EVENT_SILVERCAVEITEMROOMS_HIDDEN_ULTRA_BALL
; used 36
...
; CooltrainerM
	...
	const EVENT_BEAT_COOLTRAINERM_CALLUM
...
; Berries and Apricorns
	...
	const EVENT_BEHIND_BILLS_HOUSE_LUM_BERRY
...
; Sour Crystal events
;	const EVENT_ROUTE_39_BAOBA_GAVE_EXP_SHARE
...
;	const EVENT_BEAT_COOL_DUO_THOM_AND_KAE
...
;	const EVENT_BEAT_SUPER_NERD_WALDO
;	const EVENT_BEAT_SUPER_NERD_MERLE
;	const EVENT_SCIENTIST_LOWELL
;	const EVENT_SCIENTIST_LOWELL_DEFEATED
;	const EVENT_SCIENTIST_DANNIE
;	const EVENT_SCIENTIST_DANNIE_DEFEATED
;	const EVENT_SUPER_NERD_CARY
;	const EVENT_SUPER_NERD_CARY_DEFEATED
;	const EVENT_SCIENTIST_LINDEN
;	const EVENT_SCIENTIST_LINDEN_DEFEATED
;	const EVENT_SUPER_NERD_WALDO
;	const EVENT_SUPER_NERD_WALDO_DEFEATED
;	const EVENT_SUPER_NERD_MERLE
;	const EVENT_SUPER_NERD_MERLE_DEFEATED
;	const EVENT_BEAT_SCHOOLBOY_SHERMAN
;	const EVENT_BEAT_COOLTRAINERM_FRENCH
;	const EVENT_BEAT_YOUNGSTER_REGIS
;	const EVENT_BEAT_COOL_DUO_ZAC_AND_JEN
...
;	const EVENT_BEAT_SAILOR_EDDY
;	const EVENT_BEAT_PICNICKER_SELINA
;	const EVENT_BEAT_TWINS_MOEANDLULU
;	const EVENT_BEAT_GENTLEMAN_MILTON
;	const EVENT_BEAT_FISHER_KYLER
;	const EVENT_BEAT_BIRD_KEEPER_JACOB
...
;	const EVENT_BEAT_PICNICKER_CHEL
...
;	const EVENT_BEAT_COOL_DUO_ELAN_AND_IDA
;	const EVENT_BEAT_COOLTRAINERM_ARWIN
