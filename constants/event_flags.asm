...
; Kanto hidden items (silvermirror)
	...
	const EVENT_ROUTE23_HIDDEN_MAX_ETHER
	const EVENT_ROUTE23_HIDDEN_ULTRA_BALL
	const EVENT_ROUTE23_HIDDEN_FULL_RESTORE
	const EVENT_VICTORY_ROAD_2F_HIDDEN_ULTRA_BALL
	const EVENT_VICTORY_ROAD_2F_HIDDEN_FULL_RESTORE
...
; Elite Four and Champion
	const EVENT_BEAT_E4_WILL
	const EVENT_BEAT_E4_KOGA
	const EVENT_BEAT_E4_BRUNO
	const EVENT_BEAT_E4_KAREN
