...
; used 105
; running total used 205
;

	const_next 300
; Kanto people ; Johto people
...
; used 1
; group total used 1
; running total used 000
;

;	const_next ;000
; Johto hidden items (silvermirror)
	const_skip
; used 1
; group total used 1
; running total used 000
...
; Scientist
	...
	const EVENT_BEAT_SCIENTIST_THOMAS
	const EVENT_BEAT_SCIENTIST_DUDLEY
	const EVENT_BEAT_SCIENTIST_GAEL
; Youngster
...
; Gentleman
	...
	const EVENT_BEAT_GENTLEMAN_ALLEN
...
; Burglar
	...
	const EVENT_BEAT_BURGLAR_SPENCER
; Firebreather
...
;
; Johto story events
	const EVENT_CAN_GIVE_GS_BALL_TO_KURT               ; KEEP
	const EVENT_GAVE_GS_BALL_TO_KURT                   ; KEEP
	const EVENT_FOREST_IS_RESTLESS                     ; KEEP
	const EVENT_LAKE_OF_RAGE_EXPLAINED_WEIRD_MAGIKARP  ; KEEP
	const EVENT_LAKE_OF_RAGE_ASKED_FOR_MAGIKARP        ; KEEP
	const EVENT_LAKE_OF_RAGE_ELIXIR_ON_STANDBY         ; KEEP
	const EVENT_AZALEA_TOWN_KURT                       ; KEEP
	const EVENT_ILEX_FOREST_KURT                       ; keep?
	const EVENT_FOUGHT_SUDOWOODO                       ; KEEP
	const EVENT_HEALED_MOOMOO                          ; KEEP
	const EVENT_TALKED_TO_FARMER_ABOUT_MOOMOO          ; KEEP
	const EVENT_GOT_SHUCKIE                            ; keep?
	const EVENT_MANIA_TOOK_SHUCKIE_OR_LET_YOU_KEEP_HIM ; keep?
...
;	const EVENT_ROUTE_39_BAOBA_RETURNED_TO_SAFARI_ZONE
...
; More Sour Crystal events
	...
	const EVENT_CINNABAR_MANSION_ROCK_SMASHED
;
; Johto people
; Sprite visibility flags
; When these events are cleared, the sprite becomes visible; when set, the sprite is hidden.
...
;	const EVENT_DAY_CARE_MON_1 ; used in silvermirror
;	const EVENT_DAY_CARE_MON_2 ; used in silvermirror
;	const EVENT_MET_BILL
;	const EVENT_RIVAL_DRAGONS_DEN
;	const EVENT_PLAYERS_HOUSE_MOM_1 ; used in silvermirror
;	const EVENT_PLAYERS_HOUSE_MOM_2 ; used in silvermirror
...
;	const EVENT_RESTORED_POWER_TO_KANTO                    ; moved to silvermirror
...
;	const EVENT_ENABLE_DIPLOMA_PRINTING                    ; moved to silvermirror
...
;	const EVENT_MT_MOON_SQUARE_ROCK                        ;moved to silvermirror
;	const EVENT_MT_MOON_SQUARE_CLEFAIRY                    ;moved to silvermirror
;	const EVENT_MT_MOON_RIVAL
;	const EVENT_INDIGO_PLATEAU_POKECENTER_RIVAL
;	const EVENT_TELEPORT_GUY                               ;moved to silvermirror
;
; Kanto itemballs (crystal)
...
;	const EVENT_MOUNT_MOON_SQUARE_HIDDEN_MOON_STONE        ;moved to silvermirror
