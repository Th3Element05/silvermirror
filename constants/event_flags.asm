...
; Firebreather	
	const EVENT_BEAT_FIREBREATHER_DUSTIN
	const EVENT_BEAT_FIREBREATHER_FINNLEY
	const EVENT_BEAT_FIREBREATHER_DRAKE
	const EVENT_BEAT_FIREBREATHER_JEREMY
...
; Juggler	
	...
	const EVENT_BEAT_JUGGLER_BILL
	const EVENT_BEAT_JUGGLER_RAY
