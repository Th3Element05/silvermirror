...
; The map script command macros `setevent` and `clearevent` set/clear these flags, and their effects will be seen when the map is reloaded.
	...
	const EVENT_INDIGO_POKECENTER_ABRA_GUY
...
;	const EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER
	...
	const EVENT_JOHTO_GYM_LEADERS
	const EVENT_JOHTO_LEADER_REMATCHES
...
; Ruins of Alph itemballs
	const EVENT_KABUTO_ITEM_ROOM_MIRACLE_SEED
	const EVENT_KABUTO_ITEM_ROOM_DOME_FOSSIL
	const EVENT_KABUTO_ITEM_ROOM_PEARL
	const EVENT_KABUTO_ITEM_ROOM_REVIVAL_HERB
	const EVENT_AERODACTYL_ITEM_ROOM_CHARCOAL
	const EVENT_AERODACTYL_ITEM_ROOM_OLD_AMBER
	const EVENT_AERODACTYL_ITEM_ROOM_STARDUST
	const EVENT_AERODACTYL_ITEM_ROOM_REVIVAL_HERB
	const EVENT_OMANYTE_ITEM_ROOM_MYSTIC_WATER
	const EVENT_OMANYTE_ITEM_ROOM_HELIX_FOSSIL
	const EVENT_OMANYTE_ITEM_ROOM_BIG_PEARL
	const EVENT_OMANYTE_ITEM_ROOM_REVIVAL_HERB
	const EVENT_HO_OH_ITEM_ROOM_SACRED_ASH
	const EVENT_HO_OH_ITEM_ROOM_NUGGET
	const EVENT_HO_OH_ITEM_ROOM_STAR_PIECE
