...
; Kanto hidden items (silvermirror)
	...
	const EVENT_ROUTE23_HIDDEN_MAX_ETHER                   ;done
	const EVENT_ROUTE23_HIDDEN_ULTRA_BALL                  ;done
	const EVENT_ROUTE23_HIDDEN_FULL_RESTORE                ;done
...
;	const EVENT_MT_MORTAR_OBTAINED_HELIX_FOSSIL
;	const EVENT_MT_MORTAR_OBTAINED_DOME_FOSSIL
;	const EVENT_HELIX_FOSSIL_AT_MT_MOON
;	const EVENT_DOME_FOSSIL_AT_MT_MOON
;	const EVENT_MT_MOON_OBTAINED_FOSSIL