...
; The map script command macros `setevent` and `clearevent` set/clear these flags, and their effects will be seen when the map is reloaded.
	...
	const EVENT_SS_ANNE_ROOMS_1F_TM_BODY_SLAM
	const EVENT_SS_ANNE_ROOMS_B1F_TM_REST
	const EVENT_SS_ANNE_ROOMS_B1F_ETHER
	const EVENT_SS_ANNE_ROOMS_B1F_MAX_POTION
...
; Guitarist
	...
	const EVENT_BEAT_GUITARIST_ANDRE
; Hiker
...
; Biker
	...
	const EVENT_BEAT_BIKER_RICHARD
	const EVENT_BEAT_BIKER_VICTOR
	const EVENT_BEAT_BIKER_PEDRO
; Burglar
...
; Juggler
	...
	const EVENT_BEAT_JUGGLER_ADAM
	const EVENT_BEAT_JUGGLER_AUSTIN
	const EVENT_BEAT_JUGGLER_EMMETT
	const EVENT_BEAT_JUGGLER_DARIO
	const EVENT_BEAT_JUGGLER_GILBERT
	const EVENT_BEAT_JUGGLER_IRWIN
	const EVENT_BEAT_JUGGLER_JARED
...
; Camper
	...
	const EVENT_BEAT_CAMPER_NELSON
; Sage
