...
;	const PHONE_ELM
	...
	const PHONE_COOLTRAINERM_GAVIN
...
; example: specialphonecall SPECIALCALL_ROBBED
	const_def
	...
	const SPECIALCALL_MTSILVER       ;only outside
...
DEF CONTACT_LIST_SIZE EQU 12 ;10
