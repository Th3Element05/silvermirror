...
; Music indexes (see audio/music_pointers.asm)
	const_def
	const MUSIC_NONE                         ; 00
	const MUSIC_TITLE                        ; 01 samename
	const MUSIC_ROUTE_1                      ; 02 samename
	const MUSIC_ROUTE_3                      ; 03 samename
	const MUSIC_ROUTE_12                     ; 04
	const MUSIC_MAGNET_TRAIN                 ; 05
	const MUSIC_KANTO_GYM_LEADER_BATTLE      ; 06
	const MUSIC_KANTO_TRAINER_BATTLE         ; 07 samename
	const MUSIC_KANTO_WILD_BATTLE            ; 08 samename
	const MUSIC_POKEMON_CENTER               ; 09
	const MUSIC_SCIENTIST_ENCOUNTER          ; 0a MUSIC_HIKER_ENCOUNTER              ; 0a
	const MUSIC_LASS_ENCOUNTER               ; 0b
	const MUSIC_TRAINER_ENCOUNTER            ; 0c MUSIC_OFFICER_ENCOUNTER            ; 0c
	const MUSIC_HEAL                         ; 0d
	const MUSIC_LAVENDER_TOWN                ; 0e
	const MUSIC_VIRIDIAN_FOREST              ; 0f MUSIC_ROUTE_2                      ; 0f
	...
	const MUSIC_CITIES_1                     ; 15 MUSIC_VIRIDIAN_CITY                ; 15
	...
	const MUSIC_RIVAL_ENCOUNTER              ; 1f samename
	const MUSIC_POKEMON_TOWER                ; 20 MUSIC_RIVAL_AFTER                  ; 20
	...
	const MUSIC_VERMILION_CITY               ; 3e samename
...
; new to Crystal
	...
	const MUSIC_SS_ANNE                      ; 5e MUSIC_MOBILE_ADAPTER_MENU          ; 5e 
	const MUSIC_JIGGLYPUFF_SONG              ; 5f MUSIC_MOBILE_ADAPTER               ; 5f
	const MUSIC_BUENAS_PASSWORD              ; 60
	const MUSIC_MYSTICALMAN_ENCOUNTER        ; 61
	const MUSIC_POWER_PLANT                  ; 62 MUSIC_CRYSTAL_OPENING              ; 62
	const MUSIC_BATTLE_TOWER_THEME           ; 63
	const MUSIC_SUICUNE_BATTLE               ; 64
	const MUSIC_BATTLE_TOWER_LOBBY           ; 65
	const MUSIC_KANTO_GAME_CORNER            ; 66 MUSIC_MOBILE_CENTER                ; 66
; new to SourCrystal
	const MUSIC_ROUTE_4                      ; 67 MUSIC_ROUTE_47_HGSS                ; 67
	const MUSIC_SAFARI_ZONE                  ; 68 MUSIC_SAFARI_ZONE_GATE_HGSS        ; 68
	const MUSIC_CITIES_2                     ; 69 MUSIC_CERULEAN_CITY_HGSS           ; 69
	const MUSIC_SILPH_CO                     ; 70 MUSIC_NUGGET_BRIDGE_HGSS           ; 70
	const MUSIC_CINNABAR_ISLAND              ; 71 MUSIC_CINNABAR_ISLAND_HGSS         ; 71
	const MUSIC_HO_OH_BATTLE_HGSS            ; 72
	const MUSIC_LUGIA_BATTLE_HGSS            ; 73
	const MUSIC_OAK_INTRO                    ; 74 MUSIC_KANTO_LEGEND_BATTLE          ; 74
	const MUSIC_CINNABAR_MANSION             ; 75
	const MUSIC_ROCKET_KANTO_ENCOUNTER       ; 76 new silvermirror
