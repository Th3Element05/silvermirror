...
INCLUDE "audio/music/vermilioncity.asm" ; samename
INCLUDE "audio/music/titlescreen.asm" ; samename
INCLUDE "audio/music/ruinsofalphinterior.asm"
INCLUDE "audio/music/lookpokemaniac.asm"
INCLUDE "audio/music/trainervictory.asm"
INCLUDE "audio/music/viridianforest.asm" ; "audio/music/route2.asm"


SECTION "Songs 2", ROMX

INCLUDE "audio/music/route1.asm" ; samename
INCLUDE "audio/music/route3.asm" ; samename
INCLUDE "audio/music/route12.asm"
INCLUDE "audio/music/kantogymbattle.asm" ; samename
INCLUDE "audio/music/kantotrainerbattle.asm" ; samename
INCLUDE "audio/music/kantowildbattle.asm" ; samename
INCLUDE "audio/music/pokemoncenter.asm"
INCLUDE "audio/music/looklass.asm" ; samename
INCLUDE "audio/music/looktrainer.asm" ; "audio/music/lookofficer.asm"
;INCLUDE "audio/music/viridianforest.asm" ; "audio/music/route2.asm"
...
INCLUDE "audio/music/indigoplateau.asm" ; samename
INCLUDE "audio/music/route37.asm"
INCLUDE "audio/music/rockethideout.asm" ; samename
...
INCLUDE "audio/music/lavendertown.asm" ; samename
...
INCLUDE "audio/music/cities1.asm" ; "audio/music/viridiancity.asm"
INCLUDE "audio/music/celadoncity.asm" ; samename
...
INCLUDE "audio/music/lookrival.asm" ; samename
INCLUDE "audio/music/pokemontower.asm" ; "audio/music/aftertherivalfight.asm"
; assert BANK(Music_LookRival) == BANK(Music_AfterTheRivalFight)

INCLUDE "audio/music/surf.asm" ; samename
...
INCLUDE "audio/music/lookscientist.asm" ; "audio/music/lookhiker.asm"
...
INCLUDE "audio/music/ssanne.asm" ; "audio/music/mobileadaptermenu.asm"
INCLUDE "audio/music/buenaspassword.asm"
INCLUDE "audio/music/lookmysticalman.asm"
INCLUDE "audio/music/powerplant.asm" ; "audio/music/crystalopening.asm"
INCLUDE "audio/music/battletowertheme.asm"
INCLUDE "audio/music/suicunebattle.asm"
INCLUDE "audio/music/battletowerlobby.asm"
INCLUDE "audio/music/kantogamecorner.asm" ; "audio/music/mobilecenter.asm"
...
INCLUDE "audio/music/jigglypuffsong.asm" ; "audio/music/mobileadapter.asm"
...
INCLUDE "audio/music/route4.asm" ; "audio/music/route47.asm"
INCLUDE "audio/music/safarizone.asm" ; "audio/music/safarizonegate.asm"
INCLUDE "audio/music/cities2.asm" ; "audio/music/ceruleancity.asm"
INCLUDE "audio/music/silphco.asm" ; "audio/music/nuggetbridge.asm"
INCLUDE "audio/music/cinnabarisland.asm" ; samename
INCLUDE "audio/music/hoohbattle.asm"
INCLUDE "audio/music/lugiabattle.asm"
INCLUDE "audio/music/oakintro.asm" ; "audio/music/kantolegendbattle.asm"
INCLUDE "audio/music/cinnabarmansion.asm"
INCLUDE "audio/music/lookrocketkanto.asm" ; new silvermirror
