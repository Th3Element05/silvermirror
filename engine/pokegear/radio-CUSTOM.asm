...
.generate_alt_number
	...
	ld a, (SwarmLocationDataJohtoEnd - SwarmLocationDataJohto) / 5 ;SwarmLocationDataJohtoAlt
	call RandomRange ; genrate a random number between 0 and a
	ld hl, SwarmLocationDataJohto ;SwarmLocationDataJohtoAlt
	ld bc, 5
	call AddNTimes
	ld a, [hli]
	ld [wSwarmSpecies], a
...
.generate_alt_number_kanto
	ld a, (SwarmLocationDataKantoEnd - SwarmLocationDataKanto) / 5 ;SwarmLocationDataKantoAlt
	call RandomRange ; genrate a random number between 0 and a
	ld hl, SwarmLocationDataKanto ;SwarmLocationDataKantoAlt
	ld bc, 5
	call AddNTimes
	ld a, [hli]
	ld [wSwarmSpecies], a
...
;	ld bc, 2 * NUM_GRASSMON            ;silvermirror- custom encounter probabilities
	ld bc, 4 + NUM_GRASSMON            ;silvermirror+ custom encounter probabilities
	call AddNTimes
.loop3
