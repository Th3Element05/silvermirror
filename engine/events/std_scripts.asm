...
;	add_stdscript InitializeEventsScript ;silvermirror- event initialization
...
;	clearevent EVENT_USED_RADIO_TOWER_CARD_KEY
...
BugContestResults_CleanUp:
	...
	setmapscene ROUTE_35_NATIONAL_PARK_GATE, SCENE_ROUTE_35NATIONALPARKGATE_NOOP
...
.Gavin:
	farwritetext GavinNumberAcceptedText
	waitbutton
	closetext
	end
.Jose:
...
.Rob:
	farwritetext RobNumberAcceptedText ;"Call me anytime if you want to battle!"
	waitbutton
	closetext
	end
.Kyle:
...
.Gavin:
	farwritetext GavinNumberDeclinedText
	waitbutton
	closetext
	end
.Jose:
...
.Gavin:
	farwritetext GavinPhoneFullText
	waitbutton
	closetext
	end
.Jose:
