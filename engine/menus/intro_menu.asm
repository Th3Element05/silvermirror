...
InitializeWorld:
	...
	farcall InitializeEvents ;silvermirror event initialization
	ret
...
.SpawnAfterE4:
	ld a, SPAWN_PALLET ; SPAWN_NEW_BARK
	ld [wDefaultSpawnpoint], a
...
Continue_MobileAdapterMenu: ; unused
	...
	ld a, 5
	ld [wMusicFade], a
	ld a, LOW(MUSIC_POKEMON_CENTER) ; (MUSIC_MOBILE_ADAPTER_MENU)
	ld [wMusicFadeID], a
	ld a, HIGH(MUSIC_POKEMON_CENTER) ; (MUSIC_MOBILE_ADAPTER_MENU)
	ld [wMusicFadeID + 1], a
	ld c, 20
	call DelayFrames
	ld c, $1
...
if !DEF(_DEBUG)
	...
	ld a, NIDORINO ; silvermirror -WOOPER +NIDORINO
	ld [wCurSpecies], a
	ld [wCurPartySpecies], a
	call GetBaseData
