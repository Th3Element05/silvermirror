...
;	ld [wBGPals1 palette 2], a
	cp $5f ;$7f ; half of pink page color, which is $7E7F but bytes are reversed when stored in data (endianness), 
...
.morn_day
	...
	ld de, wOBPals1 palette PAL_OW_SILVER + 2 ;PAL_OW_PINK + 2
	ld bc, 1 palettes - 2
	ld a, BANK(wOBPals1)
	call FarCopyWRAM
