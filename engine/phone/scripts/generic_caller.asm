...
.Gavin:
	farwritetext GavinMonGreaterThanImaginedText
	promptbutton
	end
...
.Gavin:
	farwritetext GavinDefeatedMonText
	promptbutton
	end
...
.Gavin:
	farwritetext GavinLostAMonText
	promptbutton
	end
...
.Gavin:
	farwritetext GavinBattleRematchText
	promptbutton
	end
