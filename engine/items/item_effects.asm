...
; entries correspond to item ids (see constants/item_constants.asm)
	...
	dw NoEffect            ; GOLD_TEETH ; SLOWPOKETAIL
	...
	dw ItemfinderEffect    ; SILPH_SCOPE ; RestoreHPEffect ; RAGECANDYBAR
	dw NoEffect            ; GS_BALL
...
PokeBallEffect:
	...
	jr z, .room_in_party
	cp BATTLETYPE_NO_CATCH       ;silvermirror+
	jp z, UseBallInNoCatchBattle ;silvermirror+
...
CantCatchThisMonText:        ;silvermirror+
